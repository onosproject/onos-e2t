...
func (m *CriticalityDiagnostics) validate(all bool) error {
	...
	switch m.XProcedureCode.(type) {

	case *CriticalityDiagnostics_ProcedureCode:
	...
	switch m.XTriggeringMessage.(type) {

	case *CriticalityDiagnostics_TriggeringMessage:
		// no validation rules for TriggeringMessage

	}

	switch m.XProcedureCriticality.(type) {

	case *CriticalityDiagnostics_ProcedureCriticality:
		// no validation rules for ProcedureCriticality

	}

	switch m.XRicRequestorId.(type) {

	case *CriticalityDiagnostics_RicRequestorId:
	...
	switch m.XIEsCriticalityDiagnostics.(type) {

	case *CriticalityDiagnostics_IEsCriticalityDiagnostics:
...
func (m *E2NodeComponentConfigUpdateGnb) validate(all bool) error {
	...
	switch m.XNgApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateGnb_NgApconfigUpdate:
		// no validation rules for NgApconfigUpdate

	}

	switch m.XXnApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateGnb_XnApconfigUpdate:
		// no validation rules for XnApconfigUpdate

	}

	switch m.XE1ApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateGnb_E1ApconfigUpdate:
		// no validation rules for E1ApconfigUpdate

	}

	switch m.XF1ApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateGnb_F1ApconfigUpdate:
		// no validation rules for F1ApconfigUpdate

	}

	switch m.XX2ApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateGnb_X2ApconfigUpdate:
...
func (m *E2NodeComponentConfigUpdateEnb) validate(all bool) error {
	...
	case *E2NodeComponentConfigUpdateEnb_NgApconfigUpdate:
		// no validation rules for NgApconfigUpdate
	...
	case *E2NodeComponentConfigUpdateEnb_XnApconfigUpdate:
		// no validation rules for XnApconfigUpdate

	}

	switch m.XW1ApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateEnb_W1ApconfigUpdate:
		// no validation rules for W1ApconfigUpdate

	}

	switch m.XS1ApconfigUpdate.(type) {

	case *E2NodeComponentConfigUpdateEnb_S1ApconfigUpdate:
	...
	case *E2NodeComponentConfigUpdateEnb_X2ApconfigUpdate:
		// no validation rules for X2ApconfigUpdate
...
func (m *E2NodeComponentConfigUpdateAck) validate(all bool) error {
	...
	switch m.XFailureCause.(type) {

	case *E2NodeComponentConfigUpdateAck_FailureCause:
...
func (m *E2NodeComponentId) validate(all bool) error {
	...
	case *E2NodeComponentId_E2NodeComponentTypeNgeNbDu:

		if all {
			switch v := interface{}(m.GetE2NodeComponentTypeNgeNbDu()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, E2NodeComponentIdValidationError{
						field:  "E2NodeComponentTypeNgeNbDu",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetE2NodeComponentTypeNgeNbDu()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return E2NodeComponentIdValidationError{
					field:  "E2NodeComponentTypeNgeNbDu",
					reason: "embedded message failed validation",
...
// Validate checks the field values on E2NodeComponentNgeNbDuId with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *E2NodeComponentNgeNbDuId) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on E2NodeComponentNgeNbDuId with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// E2NodeComponentNgeNbDuIdMultiError, or nil if none found.
func (m *E2NodeComponentNgeNbDuId) ValidateAll() error {
	return m.validate(true)
}

func (m *E2NodeComponentNgeNbDuId) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, E2NodeComponentNgeNbDuIdValidationError{
					field:  "NgEnbDuId",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return E2NodeComponentNgeNbDuIdValidationError{
				field:  "NgEnbDuId",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return E2NodeComponentNgeNbDuIdMultiError(errors)
	}
	return nil
}

// E2NodeComponentNgeNbDuIdMultiError is an error wrapping multiple validation
// errors returned by E2NodeComponentNgeNbDuId.ValidateAll() if the designated
// constraints aren't met.
type E2NodeComponentNgeNbDuIdMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m E2NodeComponentNgeNbDuIdMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m E2NodeComponentNgeNbDuIdMultiError) AllErrors() []error { return m }

// E2NodeComponentNgeNbDuIdValidationError is the validation error returned by
// E2NodeComponentNgeNbDuId.Validate if the designated constraints aren't met.
type E2NodeComponentNgeNbDuIdValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e E2NodeComponentNgeNbDuIdValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e E2NodeComponentNgeNbDuIdValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e E2NodeComponentNgeNbDuIdValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e E2NodeComponentNgeNbDuIdValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e E2NodeComponentNgeNbDuIdValidationError) ErrorName() string {
	return "E2NodeComponentNgeNbDuIdValidationError"
}

// Error satisfies the builtin error interface
func (e E2NodeComponentNgeNbDuIdValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sE2NodeComponentNgeNbDuId.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = E2NodeComponentNgeNbDuIdValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = E2NodeComponentNgeNbDuIdValidationError{}
...
func (m *GlobalE2NodeEnGnbId) validate(all bool) error {
	...
	switch m.XEnGNbCuUpId.(type) {

	case *GlobalE2NodeEnGnbId_EnGNbCuUpId:

		if all {
			switch v := interface{}(m.GetEnGNbCuUpId()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GlobalE2NodeEnGnbIdValidationError{
						field:  "EnGNbCuUpId",
		...
		} else if v, ok := interface{}(m.GetEnGNbCuUpId()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GlobalE2NodeEnGnbIdValidationError{
					field:  "EnGNbCuUpId",
					reason: "embedded message failed validation",
	...
	switch m.XEnGNbDuId.(type) {

	case *GlobalE2NodeEnGnbId_EnGNbDuId:

		if all {
			switch v := interface{}(m.GetEnGNbDuId()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GlobalE2NodeEnGnbIdValidationError{
						field:  "EnGNbDuId",
		...
		} else if v, ok := interface{}(m.GetEnGNbDuId()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GlobalE2NodeEnGnbIdValidationError{
					field:  "EnGNbDuId",
					reason: "embedded message failed validation",
...
func (m *GlobalE2NodeGnbId) validate(all bool) error {
	...
	switch m.XGlobalEnGNbId.(type) {

	case *GlobalE2NodeGnbId_GlobalEnGNbId:
	...
	case *GlobalE2NodeGnbId_GNbCuUpId:
	...
	case *GlobalE2NodeGnbId_GNbDuId:
...
func (m *GlobalE2NodeNgEnbId) validate(all bool) error {
	...
	case *GlobalE2NodeNgEnbId_GlobalENbId:
	...
	switch m.XNgEnbDuId.(type) {

	case *GlobalE2NodeNgEnbId_NgEnbDuId:
...
func (m *Tnlinformation) validate(all bool) error {
	...
	switch m.XTnlPort.(type) {

	case *Tnlinformation_TnlPort:
...
// ValidateAll checks the field values on TransactionId with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in TransactionIdMultiError, or
// nil if none found.
func (m *TransactionId) ValidateAll() error {
	return m.validate(true)
}

func (m *TransactionId) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if val := m.GetValue(); val < 0 || val > 255 {
		err := TransactionIdValidationError{
			field:  "Value",
			reason: "value must be inside range [0, 255]",
		}
		if !all {
	...
	if len(errors) > 0 {
		return TransactionIdMultiError(errors)
	}
	return nil
}

// TransactionIdMultiError is an error wrapping multiple validation errors
// returned by TransactionId.ValidateAll() if the designated constraints
// aren't met.
type TransactionIdMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TransactionIdMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TransactionIdMultiError) AllErrors() []error { return m }
