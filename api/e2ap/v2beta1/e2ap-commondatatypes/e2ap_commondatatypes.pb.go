...
func (Criticality) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{0}
}
...
func (Presence) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{1}
}
...
func (TriggeringMessage) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{2}
}

//{-}
type CriticalityReject struct {
	Criticality          Criticality `protobuf:"varint,1,opt,name=criticality,proto3,enum=e2ap.v2beta1.Criticality" json:"criticality,omitempty"`
...
type PresenceOptional struct {
	Presence             Presence `protobuf:"varint,1,opt,name=presence,proto3,enum=e2ap.v2beta1.Presence" json:"presence,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*PresenceOptional) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{3}
}
...
func (*PresenceConditional) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{4}
}
...
func (*PresenceMandatory) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{5}
}
...
func (*ProcedureCode) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{6}
}
...
func (*ProtocolIeId) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{7}
}
...
func (*RiccallProcessId) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{8}
}
...
func (*RiccontrolHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{9}
}
...
func (*RiccontrolMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{10}
}
...
func (*RiccontrolOutcome) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{11}
}
...
func (*RicindicationHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{12}
}
...
func (*RicindicationMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{13}
}
...
func (*RanfunctionDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{14}
}
...
func (*RanfunctionOid) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{15}
}
...
func (*PlmnIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{16}
}
...
func (*RiceventTriggerDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{17}
}
...
func (*RicactionDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{18}
}
...
func (*BitString) Descriptor() ([]byte, []int) {
	return fileDescriptor_87c3d635b3027557, []int{19}
}
...
func (m *BitString) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func init() {
	proto.RegisterEnum("e2ap.v2beta1.Criticality", Criticality_name, Criticality_value)
	proto.RegisterEnum("e2ap.v2beta1.Presence", Presence_name, Presence_value)
	proto.RegisterEnum("e2ap.v2beta1.TriggeringMessage", TriggeringMessage_name, TriggeringMessage_value)
	proto.RegisterType((*CriticalityReject)(nil), "e2ap.v2beta1.CriticalityReject")
	proto.RegisterType((*CriticalityIgnore)(nil), "e2ap.v2beta1.CriticalityIgnore")
	proto.RegisterType((*CriticalityNotify)(nil), "e2ap.v2beta1.CriticalityNotify")
	proto.RegisterType((*PresenceOptional)(nil), "e2ap.v2beta1.PresenceOptional")
	proto.RegisterType((*PresenceConditional)(nil), "e2ap.v2beta1.PresenceConditional")
	proto.RegisterType((*PresenceMandatory)(nil), "e2ap.v2beta1.PresenceMandatory")
	proto.RegisterType((*ProcedureCode)(nil), "e2ap.v2beta1.ProcedureCode")
	proto.RegisterType((*ProtocolIeId)(nil), "e2ap.v2beta1.ProtocolIeId")
	proto.RegisterType((*RiccallProcessId)(nil), "e2ap.v2beta1.RiccallProcessId")
	proto.RegisterType((*RiccontrolHeader)(nil), "e2ap.v2beta1.RiccontrolHeader")
	proto.RegisterType((*RiccontrolMessage)(nil), "e2ap.v2beta1.RiccontrolMessage")
	proto.RegisterType((*RiccontrolOutcome)(nil), "e2ap.v2beta1.RiccontrolOutcome")
	proto.RegisterType((*RicindicationHeader)(nil), "e2ap.v2beta1.RicindicationHeader")
	proto.RegisterType((*RicindicationMessage)(nil), "e2ap.v2beta1.RicindicationMessage")
	proto.RegisterType((*RanfunctionDefinition)(nil), "e2ap.v2beta1.RanfunctionDefinition")
	proto.RegisterType((*RanfunctionOid)(nil), "e2ap.v2beta1.RanfunctionOid")
	proto.RegisterType((*PlmnIdentity)(nil), "e2ap.v2beta1.PlmnIdentity")
	proto.RegisterType((*RiceventTriggerDefinition)(nil), "e2ap.v2beta1.RiceventTriggerDefinition")
	proto.RegisterType((*RicactionDefinition)(nil), "e2ap.v2beta1.RicactionDefinition")
	proto.RegisterType((*BitString)(nil), "e2ap.v2beta1.BitString")
}

func init() {
	proto.RegisterFile("api/e2ap/v2beta1/e2ap_commondatatypes.proto", fileDescriptor_87c3d635b3027557)
}

var fileDescriptor_87c3d635b3027557 = []byte{
	// 675 bytes of a gzipped FileDescriptorProto
	,
}
