...
func (*ProtocolIeContainer001) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{0}
}
...
func (*ProtocolIeSingleContainer001) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{1}
}
...
type ProtocolIeField001 struct {
	...
	Criticality          e2ap_commondatatypes.Criticality `protobuf:"varint,2,opt,name=criticality,proto3,enum=e2ap.v2beta1.Criticality" json:"criticality,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (*ProtocolIeField001) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{2}
}
...
func (*ProtocolIeContainerPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{3}
}
...
func (*ProtocolIeFieldPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{4}
}
...
func (*ProtocolIeContainerList) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{5}
}
...
func (*ProtocolIeContainerPairList) Descriptor() ([]byte, []int) {
	return fileDescriptor_f07e69807ecb34c2, []int{6}
}
...
func init() {
	proto.RegisterType((*ProtocolIeContainer001)(nil), "e2ap.v2beta1.ProtocolIeContainer001")
	proto.RegisterType((*ProtocolIeSingleContainer001)(nil), "e2ap.v2beta1.ProtocolIeSingleContainer001")
	proto.RegisterType((*ProtocolIeField001)(nil), "e2ap.v2beta1.ProtocolIeField001")
	proto.RegisterType((*ProtocolIeContainerPair)(nil), "e2ap.v2beta1.ProtocolIeContainerPair")
	proto.RegisterType((*ProtocolIeFieldPair)(nil), "e2ap.v2beta1.ProtocolIeFieldPair")
	proto.RegisterType((*ProtocolIeContainerList)(nil), "e2ap.v2beta1.ProtocolIeContainerList")
	proto.RegisterType((*ProtocolIeContainerPairList)(nil), "e2ap.v2beta1.ProtocolIeContainerPairList")
}

func init() {
	proto.RegisterFile("api/e2ap/v2beta1/e2ap_containers.proto", fileDescriptor_f07e69807ecb34c2)
}

var fileDescriptor_f07e69807ecb34c2 = []byte{
	...
	0x36, 0xc9, 0xf7, 0x9a, 0x19, 0x76, 0xc8, 0x0d, 0x0b, 0xc1, 0x92, 0x2e, 0x0b, 0xad, 0xc4, 0x9d,
	0x4b, 0x64, 0x4e, 0xfa, 0xf1, 0xc1, 0x55, 0x80, 0x0c, 0x02, 0x19, 0xc5, 0x66, 0x18, 0x29, 0x54,
	...
	0xff, 0xff, 0xf3, 0xa2, 0xa3, 0x99, 0x39, 0x03, 0x00, 0x00,
}
