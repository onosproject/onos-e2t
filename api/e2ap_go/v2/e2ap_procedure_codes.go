...
const (
	...
	ProcedureCodeIDRICsubscriptionDeleteRequired ProcedureCodeT = 12
)
...
const (
	...
	ProtocolIeIDE2nodeComponentConfigAddition        ProtocolIeID = 50
	ProtocolIeIDE2nodeComponentConfigAdditionItem    ProtocolIeID = 51
	ProtocolIeIDE2nodeComponentConfigAdditionAck     ProtocolIeID = 52
	ProtocolIeIDE2nodeComponentConfigAdditionAckItem ProtocolIeID = 53
	ProtocolIeIDE2nodeComponentConfigRemoval         ProtocolIeID = 54
	ProtocolIeIDE2nodeComponentConfigRemovalItem     ProtocolIeID = 55
	ProtocolIeIDE2nodeComponentConfigRemovalAck      ProtocolIeID = 56
	ProtocolIeIDE2nodeComponentConfigRemovalAckItem  ProtocolIeID = 57
	ProtocolIeIDE2nodeTNLassociationRemoval          ProtocolIeID = 58
	ProtocolIeIDE2nodeTNLassociationRemovalItem      ProtocolIeID = 59
	ProtocolIeIDRICsubscriptionToBeRemoved           ProtocolIeID = 60
	ProtocolIeIDRICsubscriptionWithCauseItem         ProtocolIeID = 61
)
