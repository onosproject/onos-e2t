...
#protoc -I=$proto_imports --validate_out=lang=go:. --proto_path=api --gogo_out=$go_import_paths,import_path=github.com/onosproject/onos-e2t/api:. --experimental_allow_proto3_optional api/e2ap/v2beta1/e2ap_pdu_contents.proto
