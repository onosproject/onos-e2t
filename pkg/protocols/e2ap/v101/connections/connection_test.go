...
func TestChannels(t *testing.T) {
	...
	e2NodeCh := NewE2NodeConn(clientConn, func(channel E2NodeConn) procedures.E2NodeProcedures {
		return &testClientProcedures{}
	})
	ricCh := NewRICConn(serverConn, func(channel RICConn) procedures.RICProcedures {
