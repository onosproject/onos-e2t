...
func CreateRicServiceUpdateFailureE2apPdu(rfRejected types.RanFunctionCauses, ttw *e2apies.TimeToWait, failureProcCode *v2beta1.ProcedureCodeT, failureCrit *e2ap_commondatatypes.Criticality,
	...
	if rfRejected == nil && ttw == nil && reqID == nil && critDiags == nil {
	...
	if rfRejected != nil {
		...
		e2apPdu.GetUnsuccessfulOutcome().GetProcedureCode().GetRicServiceUpdate().GetUnsuccessfulOutcome().GetProtocolIes().E2ApProtocolIes13 = &ranFunctionsRejected
	}
	...
	if ttw != nil {
		...
		e2apPdu.GetUnsuccessfulOutcome().GetProcedureCode().GetRicServiceUpdate().GetUnsuccessfulOutcome().GetProtocolIes().E2ApProtocolIes31 = &timeToWait
	}
	...
	if failureProcCode != nil && failureTrigMsg != nil && failureCrit != nil && reqID != nil {
		...
		e2apPdu.GetUnsuccessfulOutcome().GetProcedureCode().GetRicServiceUpdate().GetUnsuccessfulOutcome().GetProtocolIes().E2ApProtocolIes2 = &criticalityDiagnostics
	}
