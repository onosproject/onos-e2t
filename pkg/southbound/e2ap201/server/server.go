...
import (
	...
	"github.com/onosproject/onos-e2t/pkg/southbound/e2ap201/pdubuilder"
	"github.com/onosproject/onos-e2t/pkg/southbound/e2ap201/pdudecoder"
	"github.com/onosproject/onos-e2t/pkg/southbound/e2ap201/types"
)

var log = logging.GetLogger("southbound", "e2apv201", "server")
...
func (s *E2Server) Serve() error {
	return s.server.Serve(func(conn e2.ServerConn) e2.ServerInterface {
		return &E2ChannelServer{
			...
			streams:        s.subs,
			streamsv2beta1: s.streamsv2beta1,
...
func (e *E2ChannelServer) E2Setup(ctx context.Context, request *e2appducontents.E2SetupRequest) (*e2appducontents.E2SetupResponse, *e2appducontents.E2SetupFailure, error) {
	...
	e.e2Conn = NewE2Conn(createE2NodeURI(nodeIdentity), plmnID, nodeIdentity, e.serverConn, e.streamsv2beta1, serviceModels, ranFunctions, e2Cells, time.Now())
...
func (e *E2ChannelServer) E2ConfigurationUpdate(ctx context.Context, request *e2appducontents.E2NodeConfigurationUpdate) (response *e2appducontents.E2NodeConfigurationUpdateAcknowledge, failure *e2appducontents.E2NodeConfigurationUpdateFailure, err error) {
	panic("implement me")
}
