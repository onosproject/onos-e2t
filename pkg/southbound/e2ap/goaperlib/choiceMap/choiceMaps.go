...
var e2ApPduChoicemap = map[string]map[int]reflect.Type{
	"e2_ap_pdu": {
		1: reflect.TypeOf(e2appdudescriptions.E2ApPdu_InitiatingMessage{}),
		2: reflect.TypeOf(e2appdudescriptions.E2ApPdu_SuccessfulOutcome{}),
		3: reflect.TypeOf(e2appdudescriptions.E2ApPdu_UnsuccessfulOutcome{}),
	},
	"cause": {
...
//const im_values8 = reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicSubscription{}).String()

var e2ApPduCanonicalChoicemap = map[string]map[int64]reflect.Type{
	"im_values": {
		int64(v2.ProcedureCodeIDRICsubscription):               reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicSubscription{}),
		int64(v2.ProcedureCodeIDRICsubscriptionDelete):         reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicSubscriptionDelete{}),
		int64(v2.ProcedureCodeIDRICserviceUpdate):              reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicServiceUpdate{}),
		int64(v2.ProcedureCodeIDRICcontrol):                    reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicControl{}),
		int64(v2.ProcedureCodeIDE2setup):                       reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_E2Setup{}),
		int64(v2.ProcedureCodeIDE2nodeConfigurationUpdate):     reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_E2NodeConfigurationUpdate{}),
		int64(v2.ProcedureCodeIDE2connectionUpdate):            reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_E2ConnectionUpdate{}),
		int64(v2.ProcedureCodeIDReset):                         reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_Reset_{}),
		int64(v2.ProcedureCodeIDRICindication):                 reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicIndication{}),
		int64(v2.ProcedureCodeIDRICserviceQuery):               reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicServiceQuery{}),
		int64(v2.ProcedureCodeIDErrorIndication):               reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_ErrorIndication{}),
		int64(v2.ProcedureCodeIDRICsubscriptionDeleteRequired): reflect.TypeOf(e2appdudescriptions.InitiatingMessageE2ApElementaryProcedures_RicSubscriptionDeleteRequired{}),
	},
	"so_values": {
		int64(v2.ProcedureCodeIDRICsubscription):           reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_RicSubscription{}),
		int64(v2.ProcedureCodeIDRICsubscriptionDelete):     reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_RicSubscriptionDelete{}),
		int64(v2.ProcedureCodeIDRICserviceUpdate):          reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_RicServiceUpdate{}),
		int64(v2.ProcedureCodeIDRICcontrol):                reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_RicControl{}),
		int64(v2.ProcedureCodeIDE2setup):                   reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_E2Setup{}),
		int64(v2.ProcedureCodeIDE2nodeConfigurationUpdate): reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_E2NodeConfigurationUpdate{}),
		int64(v2.ProcedureCodeIDE2connectionUpdate):        reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_E2ConnectionUpdate{}),
		int64(v2.ProcedureCodeIDReset):                     reflect.TypeOf(e2appdudescriptions.SuccessfulOutcomeE2ApElementaryProcedures_Reset_{}),
	},
	"uo_values": {
		int64(v2.ProcedureCodeIDRICsubscription):           reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_RicSubscription{}),
		int64(v2.ProcedureCodeIDRICsubscriptionDelete):     reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_RicSubscriptionDelete{}),
		int64(v2.ProcedureCodeIDRICserviceUpdate):          reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_RicServiceUpdate{}),
		int64(v2.ProcedureCodeIDRICcontrol):                reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_RicControl{}),
		int64(v2.ProcedureCodeIDE2setup):                   reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_E2Setup{}),
		int64(v2.ProcedureCodeIDE2nodeConfigurationUpdate): reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_E2NodeConfigurationUpdate{}),
		int64(v2.ProcedureCodeIDE2connectionUpdate):        reflect.TypeOf(e2appdudescriptions.UnsuccessfulOutcomeE2ApElementaryProcedures_E2ConnectionUpdate{}),
	},
...
//func GetChoiceMapItem(index1 string, index2 int64) (reflect.Type, error) {
//	log.Debugf()
//	//ToDo  - put mutex
//
//}
