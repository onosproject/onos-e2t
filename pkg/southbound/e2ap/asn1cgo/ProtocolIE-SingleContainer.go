...
func newRanFunctionItemIesSingleContainer(rfItemIes *e2appducontents.RanfunctionItemIes) (*C.ProtocolIE_SingleContainer_1911P8_t, error) {
	return newRANfunctionItemIEs(rfItemIes)
}

func newRanFunctionIDItemIesSingleContainer(rfIDItemIes *e2appducontents.RanfunctionIdItemIes) (*C.ProtocolIE_SingleContainer_1911P9_t, error) {
	return newRANfunctionIDItemIEs(rfIDItemIes)
}

func newRanFunctionIDcauseItemIesSingleContainer(rfIDcauseItemIes *e2appducontents.RanfunctionIdcauseItemIes) (*C.ProtocolIE_SingleContainer_1911P10_t, error) {
	return newRANfunctionIDCauseItemIEs(rfIDcauseItemIes)
}

func newE2nodeConfigurationUpdateIesSingleContainer(e2nccuItemIes *e2appducontents.E2NodeComponentConfigUpdateItemIes) (*C.ProtocolIE_SingleContainer_1911P6_t, error) {
	return newE2nodeComponentConfigUpdateItemIEs(e2nccuItemIes)
}

func newE2nodeConfigurationUpdateAckIesSingleContainer(e2nccuaItemIes *e2appducontents.E2NodeComponentConfigUpdateAckItemIes) (*C.ProtocolIE_SingleContainer_1911P7_t, error) {
	return newE2nodeComponentConfigUpdateAckItemIEs(e2nccuaItemIes)
}

func newE2connectionUpdateIesSingleContainer(e2cuItemIes *e2appducontents.E2ConnectionUpdateItemIes) (*C.ProtocolIE_SingleContainer_1911P3_t, error) {
	return newE2connectionUpdateItemIEs(e2cuItemIes)
}

func newE2connectionUpdateRemoveIesSingleContainer(e2curItemIes *e2appducontents.E2ConnectionUpdateRemoveItemIes) (*C.ProtocolIE_SingleContainer_1911P4_t, error) {
...
func newE2connectionSetupFailedIesSingleContainer(e2csfItemIes *e2appducontents.E2ConnectionSetupFailedItemIes) (*C.ProtocolIE_SingleContainer_1911P5_t, error) {
...
func decodeRanFunctionItemIesSingleContainer(rfiIeScC *C.ProtocolIE_SingleContainer_1911P8_t) (*e2appducontents.RanfunctionItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfiIeScC, rfiIeScC)
...
func decodeRanFunctionIDItemIesSingleContainer(rfIDiIeScC *C.ProtocolIE_SingleContainer_1911P9_t) (*e2appducontents.RanfunctionIdItemIes, error) {
...
func decodeE2nodeComponentConfigUpdateItemIesSingleContainer(e2nccuiIeScC *C.ProtocolIE_SingleContainer_1911P6_t) (*e2appducontents.E2NodeComponentConfigUpdateItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfIDiIeScC, rfIDiIeScC)
...
func decodeE2nodeComponentConfigUpdateAckItemIesSingleContainer(e2nccuaiIeScC *C.ProtocolIE_SingleContainer_1911P7_t) (*e2appducontents.E2NodeComponentConfigUpdateAckItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfIDiIeScC, rfIDiIeScC)
...
func decodeE2connectionUpdateItemIesSingleContainer(e2cuiIeScC *C.ProtocolIE_SingleContainer_1911P3_t) (*e2appducontents.E2ConnectionUpdateItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfIDiIeScC, rfIDiIeScC)
...
func decodeE2connectionUpdateRemoveItemIesSingleContainer(e2csfiIeScC *C.ProtocolIE_SingleContainer_1911P4_t) (*e2appducontents.E2ConnectionUpdateRemoveItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfIDiIeScC, rfIDiIeScC)
...
func decodeE2connectionSetupFailedItemIesSingleContainer(e2csfiIeScC *C.ProtocolIE_SingleContainer_1911P5_t) (*e2appducontents.E2ConnectionSetupFailedItemIes, error) {
	//fmt.Printf("Value %T %v\n", rfIDiIeScC, rfIDiIeScC)
	switch id := e2csfiIeScC.id; id {
...
func decodeRanFunctionIDCauseItemIesSingleContainer(rfIDciIeScC *C.ProtocolIE_SingleContainer_1911P10_t) (*e2appducontents.RanfunctionIdcauseItemIes, error) {
