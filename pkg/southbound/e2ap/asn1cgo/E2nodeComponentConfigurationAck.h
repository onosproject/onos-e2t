...
/* E2nodeComponentConfigurationAck__updateOutcome */
typedef long	 E2nodeComponentConfigurationAck__updateOutcome_t;
...
typedef struct E2nodeComponentConfigurationAck {
	E2nodeComponentConfigurationAck__updateOutcome_t	 updateOutcome;
