...
asn_TYPE_member_t asn_MBR_E2nodeComponentConfigUpdateENB_1[] = {
	{ ATF_POINTER, 5, offsetof(struct E2nodeComponentConfigUpdateENB, ngAPconfigUpdate),
	...
	{ ATF_POINTER, 4, offsetof(struct E2nodeComponentConfigUpdateENB, xnAPconfigUpdate),
	...
	{ ATF_POINTER, 3, offsetof(struct E2nodeComponentConfigUpdateENB, w1APconfigUpdate),
...
static const int asn_MAP_E2nodeComponentConfigUpdateENB_oms_1[] = { 0, 1, 2, 3, 4 };
...
static const asn_TYPE_tag2member_t asn_MAP_E2nodeComponentConfigUpdateENB_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* w1APconfigUpdate */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* s1APconfigUpdate */
