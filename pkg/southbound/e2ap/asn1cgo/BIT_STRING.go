...
func xerDecodeBitString(bytes []byte) (*e2ap_commondatatypes.BitString, error) {
...
func perDecodeBitString(bytes []byte) (*e2ap_commondatatypes.BitString, error) {
...
func newBitString(bs *e2ap_commondatatypes.BitString) (*C.BIT_STRING_t, error) {
