...
func newE2Channel(id ChannelID, plmdID string, channel e2.ServerChannel, streams broker.StreamBroker, modelFuncIDs map[e2smtypes.OID]types.RanFunctionID) *E2Channel {
	return &E2Channel{
