...
func newRicIndication(ri *e2appducontents.Ricindication) (*C.RICindicationVone_t, error) {
...
func decodeRicIndication(riC *C.RICindicationVone_t) (*e2appducontents.Ricindication, error) {
