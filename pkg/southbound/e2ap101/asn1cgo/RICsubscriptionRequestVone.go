...
func xerEncodeRICsubscriptionRequest(rsr *e2appducontents.RicsubscriptionRequest) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICsubscriptionRequestVone, unsafe.Pointer(rsrC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perEncodeRICsubscriptionRequest(rsr *e2appducontents.RicsubscriptionRequest) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICsubscriptionRequestVone, unsafe.Pointer(rsrC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func newRICsubscriptionRequest(rsr *e2appducontents.RicsubscriptionRequest) (*C.RICsubscriptionRequestVone_t, error) {
	pIeC1710P0, err := newRicSubscriptionRequestIes(rsr.GetProtocolIes())
	if err != nil {
		return nil, err
	}
	rsrC := C.RICsubscriptionRequestVone_t{
...
func decodeRicSubscriptionRequest(ricSubscriptionRequestC *C.RICsubscriptionRequestVone_t) (*e2appducontents.RicsubscriptionRequest, error) {
