...
func newCriticalityDiagnosticsIeList(cdIel *e2apies.CriticalityDiagnosticsIeList) (*C.CriticalityDiagnosticsVone_IE_List_t, error) {
	cdIelC := new(C.CriticalityDiagnosticsVone_IE_List_t)
...
func decodeCriticalityDiagnosticsIeList(cdIelC *C.CriticalityDiagnosticsVone_IE_List_t) (*e2apies.CriticalityDiagnosticsIeList, error) {
	...
	for i := 0; i < ieCount; i++ {
		...
		cdIeC := *(**C.CriticalityDiagnosticsVone_IE_Item_t)(unsafe.Pointer(uintptr(unsafe.Pointer(cdIelC.list.array)) + offset))
