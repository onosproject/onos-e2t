...
func xerEncodeE2connectionUpdateAcknowledge(e2connectionUpdateAcknowledge *e2ap_pdu_contents.E2ConnectionUpdateAcknowledge) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateAcknowledgeVone, unsafe.Pointer(e2connectionUpdateAcknowledgeCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdateAcknowledge() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdateAcknowledge(e2connectionUpdateAcknowledge *e2ap_pdu_contents.E2ConnectionUpdateAcknowledge) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateAcknowledgeVone, unsafe.Pointer(e2connectionUpdateAcknowledgeCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdateAcknowledge() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdateAcknowledge(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateAcknowledge, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdateAcknowledge((*C.E2connectionUpdateAcknowledgeVone_t)(unsafePtr))
}

func perDecodeE2connectionUpdateAcknowledge(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateAcknowledge, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdateAcknowledge(e2cua *e2ap_pdu_contents.E2ConnectionUpdateAcknowledge) (*C.E2connectionUpdateAcknowledgeVone_t, error) {
...
func decodeE2connectionUpdateAcknowledge(e2cuaC *C.E2connectionUpdateAcknowledgeVone_t) (*e2ap_pdu_contents.E2ConnectionUpdateAcknowledge, error) {
