...
func newRicCallProcessID(rcpID *e2ap_commondatatypes.RiccallProcessId) *C.RICcallProcessIDVone_t {
...
func decodeRicCallProcessID(rcpIDC *C.RICcallProcessIDVone_t) *e2ap_commondatatypes.RiccallProcessId {
