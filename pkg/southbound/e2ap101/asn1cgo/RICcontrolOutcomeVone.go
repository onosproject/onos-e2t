...
func newRicControlOutcome(rco *e2ap_commondatatypes.RiccontrolOutcome) *C.RICcontrolOutcomeVone_t {
...
func decodeRicControlOutcome(rcoC *C.RICcontrolOutcomeVone_t) *e2ap_commondatatypes.RiccontrolOutcome {
