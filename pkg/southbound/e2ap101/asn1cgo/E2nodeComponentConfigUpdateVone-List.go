...
func xerEncodeE2nodeComponentConfigUpdateList(e2nodeComponentConfigUpdateList *e2ap_pdu_contents.E2NodeComponentConfigUpdateList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateVone_List, unsafe.Pointer(e2nodeComponentConfigUpdateListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateList(e2nodeComponentConfigUpdateList *e2ap_pdu_contents.E2NodeComponentConfigUpdateList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateVone_List, unsafe.Pointer(e2nodeComponentConfigUpdateListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateList(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateList((*C.E2nodeComponentConfigUpdateVone_List_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateList(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateList(e2nodeComponentConfigUpdateList *e2ap_pdu_contents.E2NodeComponentConfigUpdateList) (*C.E2nodeComponentConfigUpdateVone_List_t, error) {

	e2nodeComponentConfigUpdateListC := new(C.E2nodeComponentConfigUpdateVone_List_t)
...
func decodeE2nodeComponentConfigUpdateList(e2nodeComponentConfigUpdateListC *C.E2nodeComponentConfigUpdateVone_List_t) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateList, error) {
...
func decodeE2nodeComponentConfigUpdateListBytes(e2ncculC [48]byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateList, error) {
	...
	rfIDlC := C.E2nodeComponentConfigUpdateVone_List_t{
		list: C.struct___97{
			array: array,
			size:  size,
			count: count,
