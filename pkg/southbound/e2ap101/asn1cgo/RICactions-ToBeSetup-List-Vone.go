...
func xerEncodeRicActionsToBeSetupList(ratbsl *e2appducontents.RicactionsToBeSetupList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICactions_ToBeSetup_List_Vone, unsafe.Pointer(ratbslC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perEncodeRicActionsToBeSetupList(ratbsl *e2appducontents.RicactionsToBeSetupList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICactions_ToBeSetup_List_Vone, unsafe.Pointer(ratbslC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func xerDecodeRicActionsToBeSetupList(xer []byte) (*e2appducontents.RicactionsToBeSetupList, error) {
	unsafePtr, err := decodeXer(xer, &C.asn_DEF_RICactions_ToBeSetup_List_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	ratsslC := (*C.RICactions_ToBeSetup_List_Vone_t)(unsafePtr)
	return decodeRicActionToBeSetupList(ratsslC)
}

func newRicActionToBeSetupList(ratbsL *e2appducontents.RicactionsToBeSetupList) (*C.RICactions_ToBeSetup_List_Vone_t, error) {
	ratbsLC := new(C.RICactions_ToBeSetup_List_Vone_t)
...
func decodeRicActionToBeSetupList(ratbsLC *C.RICactions_ToBeSetup_List_Vone_t) (*e2appducontents.RicactionsToBeSetupList, error) {
