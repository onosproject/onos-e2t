...
func newRicControlHeader(rch *e2ap_commondatatypes.RiccontrolHeader) *C.RICcontrolHeaderVone_t {
...
func decodeRicControlHeader(rchC *C.RICcontrolHeaderVone_t) *e2ap_commondatatypes.RiccontrolHeader {
