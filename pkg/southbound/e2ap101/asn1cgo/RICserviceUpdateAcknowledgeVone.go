...
func xerEncodeRicServiceUpdateAcknowledge(rsua *e2ap_pdu_contents.RicserviceUpdateAcknowledge) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICserviceUpdateAcknowledgeVone, unsafe.Pointer(rsuaCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeRicServiceUpdateAcknowledge() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeRicServiceUpdateAcknowledge(rsua *e2ap_pdu_contents.RicserviceUpdateAcknowledge) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICserviceUpdateAcknowledgeVone, unsafe.Pointer(rsuaCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeRicServiceUpdateAcknowledge() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeRicServiceUpdateAcknowledge(bytes []byte) (*e2ap_pdu_contents.RicserviceUpdateAcknowledge, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RICserviceUpdateAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicServiceUpdateAcknowledge((*C.RICserviceUpdateAcknowledgeVone_t)(unsafePtr))
}

func perDecodeRicServiceUpdateAcknowledge(bytes []byte) (*e2ap_pdu_contents.RicserviceUpdateAcknowledge, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RICserviceUpdateAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicServiceUpdateAcknowledge(rsua *e2ap_pdu_contents.RicserviceUpdateAcknowledge) (*C.RICserviceUpdateAcknowledgeVone_t, error) {
...
func decodeRicServiceUpdateAcknowledge(rsuaC *C.RICserviceUpdateAcknowledgeVone_t) (*e2ap_pdu_contents.RicserviceUpdateAcknowledge, error) {
