...
func newEnbID(enbID *e2apies.EnbId) (*C.ENB_ID_Vone_t, error) {
	var pr C.ENB_ID_Vone_PR
	...
	case *e2apies.EnbId_MacroENbId:
		...
		pr = C.ENB_ID_Vone_PR_macro_eNB_ID
	...
	case *e2apies.EnbId_HomeENbId:
		...
		pr = C.ENB_ID_Vone_PR_home_eNB_ID
	...
	case *e2apies.EnbId_ShortMacroENbId:
		...
		pr = C.ENB_ID_Vone_PR_short_Macro_eNB_ID
	...
	case *e2apies.EnbId_LongMacroENbId:
		...
		pr = C.ENB_ID_Vone_PR_long_Macro_eNB_ID
...
func decodeEnbID(enbIDC *C.ENB_ID_Vone_t) (*e2apies.EnbId, error) {
