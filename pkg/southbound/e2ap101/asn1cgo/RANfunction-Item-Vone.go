...
func xerEncodeRanFunctionItem(rfi *e2appducontents.RanfunctionItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RANfunction_Item_Vone, unsafe.Pointer(rfiCP))
	if err != nil {
...
func perEncodeRanFunctionItem(rfi *e2appducontents.RanfunctionItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RANfunction_Item_Vone, unsafe.Pointer(rfiCP))
	if err != nil {
...
func xerDecodeRanFunctionItem(bytes []byte) (*e2appducontents.RanfunctionItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RANfunction_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRanFunctionItem((*C.RANfunction_Item_Vone_t)(unsafePtr))
}

func perDecodeRanFunctionItem(bytes []byte) (*e2appducontents.RanfunctionItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RANfunction_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRanFunctionItem(rfItem *e2appducontents.RanfunctionItem) *C.RANfunction_Item_Vone_t {
	rfItemC := C.RANfunction_Item_Vone_t{
...
func decodeRanFunctionItemBytes(bytes [88]byte) (*e2appducontents.RanfunctionItem, error) {
	...
	rfiC := C.RANfunction_Item_Vone_t{
...
func decodeRanFunctionItem(rfiC *C.RANfunction_Item_Vone_t) (*e2appducontents.RanfunctionItem, error) {
