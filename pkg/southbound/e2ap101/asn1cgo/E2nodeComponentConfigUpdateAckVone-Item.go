...
func xerEncodeE2nodeComponentConfigUpdateAckItem(e2nodeComponentConfigUpdateAckItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone_Item, unsafe.Pointer(e2nodeComponentConfigUpdateAckItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateAckItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateAckItem(e2nodeComponentConfigUpdateAckItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone_Item, unsafe.Pointer(e2nodeComponentConfigUpdateAckItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateAckItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateAckItem(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateAckVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateAckItem((*C.E2nodeComponentConfigUpdateAckVone_Item_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateAckItem(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateAckVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateAckItem(e2nodeComponentConfigUpdateAckItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem) (*C.E2nodeComponentConfigUpdateAckVone_Item_t, error) {

	var err error
	e2nodeComponentConfigUpdateAckItemC := C.E2nodeComponentConfigUpdateAckVone_Item_t{}
...
func decodeE2nodeComponentConfigUpdateAckItem(e2nodeComponentConfigUpdateAckItemC *C.E2nodeComponentConfigUpdateAckVone_Item_t) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem, error) {
...
func decodeE2nodeComponentConfigUpdateAckItemBytes(bytes [80]byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckItem, error) {
	...
	e2nccuaiC := C.E2nodeComponentConfigUpdateAckVone_Item_t{
		e2nodeComponentType: C.long(binary.LittleEndian.Uint64(bytes[0:8])),
		e2nodeComponentID:   (*C.struct_E2nodeComponentIDVone)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[8:16])))),
		e2nodeComponentConfigUpdateAck: C.E2nodeComponentConfigUpdateAckVone_t{
			updateOutcome: C.long(binary.LittleEndian.Uint64(bytes[16:24])),
			failureCause:  (*C.struct_CauseVone)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[24:])))),
		},
	}
