...
func xerEncodeGlobalenGnbID(globalenGnbID *e2ap_ies.GlobalenGnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalenGNB_ID_Vone, unsafe.Pointer(globalenGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalenGnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalenGnbID(globalenGnbID *e2ap_ies.GlobalenGnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalenGNB_ID_Vone, unsafe.Pointer(globalenGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalenGnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalenGnbID(bytes []byte) (*e2ap_ies.GlobalenGnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalenGNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalenGnbID((*C.GlobalenGNB_ID_Vone_t)(unsafePtr))
}

func perDecodeGlobalenGnbID(bytes []byte) (*e2ap_ies.GlobalenGnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalenGNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalenGnbID(globalenGnbID *e2ap_ies.GlobalenGnbId) (*C.GlobalenGNB_ID_Vone_t, error) {

	var err error
	globalenGnbIDC := C.GlobalenGNB_ID_Vone_t{}
...
func decodeGlobalenGnbID(globalenGnbIDC *C.GlobalenGNB_ID_Vone_t) (*e2ap_ies.GlobalenGnbId, error) {
