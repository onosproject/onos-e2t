...
func newRicActionAdmittedItem(raai *e2appducontents.RicactionAdmittedItem) *C.RICaction_Admitted_Item_Vone_t {
	raaiC := C.RICaction_Admitted_Item_Vone_t{
...
func decodeRicActionAdmittedItem(raaiC C.RICaction_Admitted_Item_Vone_t) *e2appducontents.RicactionAdmittedItem {
