...
func newE2setupFailure(ei *e2appducontents.E2SetupFailure) (*C.E2setupFailureVone_t, error) {
...
func decodeE2setupFailure(eiC *C.E2setupFailureVone_t) (*e2appducontents.E2SetupFailure, error) {
