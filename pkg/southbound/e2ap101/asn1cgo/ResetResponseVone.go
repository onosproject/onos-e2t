...
func xerEncodeResetResponse(rr *e2ap_pdu_contents.ResetResponse) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_ResetResponseVone, unsafe.Pointer(rrCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeResetResponse() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeResetResponse(rr *e2ap_pdu_contents.ResetResponse) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_ResetResponseVone, unsafe.Pointer(rrCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeResetResponse() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeResetResponse(bytes []byte) (*e2ap_pdu_contents.ResetResponse, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_ResetResponseVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeResetResponse((*C.ResetResponseVone_t)(unsafePtr))
}

func perDecodeResetResponse(bytes []byte) (*e2ap_pdu_contents.ResetResponse, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_ResetResponseVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newResetResponse(rr *e2ap_pdu_contents.ResetResponse) (*C.ResetResponseVone_t, error) {
...
func decodeResetResponse(rrC *C.ResetResponseVone_t) (*e2ap_pdu_contents.ResetResponse, error) {
