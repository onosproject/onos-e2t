...
func xerEncodeE2nodeComponentConfigUpdateItem(e2nodeComponentConfigUpdateItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateVone_Item, unsafe.Pointer(e2nodeComponentConfigUpdateItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateItem(e2nodeComponentConfigUpdateItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateVone_Item, unsafe.Pointer(e2nodeComponentConfigUpdateItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateItem(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateItem((*C.E2nodeComponentConfigUpdateVone_Item_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateItem(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateItem(e2nodeComponentConfigUpdateItem *e2ap_pdu_contents.E2NodeComponentConfigUpdateItem) (*C.E2nodeComponentConfigUpdateVone_Item_t, error) {

	var err error
	e2nodeComponentConfigUpdateItemC := C.E2nodeComponentConfigUpdateVone_Item_t{}
...
func decodeE2nodeComponentConfigUpdateItem(e2nodeComponentConfigUpdateItemC *C.E2nodeComponentConfigUpdateVone_Item_t) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateItem, error) {
...
func decodeE2nodeComponentConfigUpdateItemBytes(bytes [80]byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateItem, error) {
	...
	e2nccuC := C.E2nodeComponentConfigUpdateVone_t{
		present: C.E2nodeComponentConfigUpdateVone_PR(binary.LittleEndian.Uint64(bytes[16:24])),
	}
