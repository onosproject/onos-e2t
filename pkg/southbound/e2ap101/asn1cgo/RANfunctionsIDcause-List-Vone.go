...
func newRanFunctionsIDcauseList(rfIDcl *e2appducontents.RanfunctionsIdcauseList) (*C.RANfunctionsIDcause_List_Vone_t, error) {
	rfIDclC := new(C.RANfunctionsIDcause_List_Vone_t)
...
func decodeRanFunctionsIDCauseListBytes(ranFunctionIDCauseListChoice [112]byte) (*e2appducontents.RanfunctionsIdcauseList, error) {
	...
	rfIDCauselC := C.RANfunctionsIDcause_List_Vone_t{
		list: C.struct___150{
			array: array,
			size:  size,
			count: count,
...
func decodeRanFunctionsCauseIDList(rfIDCauselC *C.RANfunctionsIDcause_List_Vone_t) (*e2appducontents.RanfunctionsIdcauseList, error) {
