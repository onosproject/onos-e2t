...
func xerEncodeGlobalE2nodeNgEnbID(globalE2nodeNgEnbID *e2ap_ies.GlobalE2NodeNgEnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalE2node_ng_eNB_ID_Vone, unsafe.Pointer(globalE2nodeNgEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalE2nodeNgEnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalE2nodeNgEnbID(globalE2nodeNgEnbID *e2ap_ies.GlobalE2NodeNgEnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalE2node_ng_eNB_ID_Vone, unsafe.Pointer(globalE2nodeNgEnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalE2nodeNgEnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalE2nodeNgEnbID(bytes []byte) (*e2ap_ies.GlobalE2NodeNgEnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalE2node_ng_eNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalE2nodeNgEnbID((*C.GlobalE2node_ng_eNB_ID_Vone_t)(unsafePtr))
}

func perDecodeGlobalE2nodeNgEnbID(bytes []byte) (*e2ap_ies.GlobalE2NodeNgEnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalE2node_ng_eNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalE2nodeNgEnbID(globalE2nodeNgEnbID *e2ap_ies.GlobalE2NodeNgEnbId) (*C.GlobalE2node_ng_eNB_ID_Vone_t, error) {

	var err error
	globalE2nodeNgEnbIDC := C.GlobalE2node_ng_eNB_ID_Vone_t{}
...
func decodeGlobalE2nodeNgEnbID(globalE2nodeNgEnbIDC *C.GlobalE2node_ng_eNB_ID_Vone_t) (*e2ap_ies.GlobalE2NodeNgEnbId, error) {
...
func decodeGlobalE2nodeNgEnbIDBytes(array [8]byte) (*e2ap_ies.GlobalE2NodeNgEnbId, error) {
	globalE2nodeNgEnbIDC := (*C.GlobalE2node_ng_eNB_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
