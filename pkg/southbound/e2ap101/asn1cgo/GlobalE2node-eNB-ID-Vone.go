...
func newGlobalE2nodeeNBID(enbID *e2apies.GlobalE2NodeEnbId) (*C.GlobalE2node_eNB_ID_Vone_t, error) {
	...
	globaleNBIDC := C.GlobalE2node_eNB_ID_Vone_t{
...
func decodeGlobalE2nodeeNBID(eNBC *C.GlobalE2node_eNB_ID_Vone_t) (*e2apies.GlobalE2NodeEnbId, error) {
...
func decodeGlobalE2nodeeNBIDBytes(array [8]byte) (*e2apies.GlobalE2NodeEnbId, error) {
	gNBC := (*C.GlobalE2node_eNB_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
