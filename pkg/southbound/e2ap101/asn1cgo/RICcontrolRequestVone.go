...
func xerEncodeRICcontrolRequest(rcr *e2appducontents.RiccontrolRequest) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICcontrolRequestVone, unsafe.Pointer(rcrC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func xerDecodeRICcontrolRequest(bytes []byte) (*e2appducontents.RiccontrolRequest, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RICcontrolRequestVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicControlRequest((*C.RICcontrolRequestVone_t)(unsafePtr))
}
...
func perEncodeRICcontrolRequest(rcr *e2appducontents.RiccontrolRequest) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICcontrolRequestVone, unsafe.Pointer(rcrC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perDecodeRICcontrolRequest(bytes []byte) (*e2appducontents.RiccontrolRequest, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RICcontrolRequestVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicControlRequest(rcr *e2appducontents.RiccontrolRequest) (*C.RICcontrolRequestVone_t, error) {
...
func decodeRicControlRequest(rcrC *C.RICcontrolRequestVone_t) (*e2appducontents.RiccontrolRequest, error) {
