...
func newRicControlAckRequest(rcar e2apies.RiccontrolAckRequest) (*C.RICcontrolAckRequestVone_t, error) {
	var ret C.RICcontrolAckRequestVone_t
	switch rcar {
	case e2apies.RiccontrolAckRequest_RICCONTROL_ACK_REQUEST_NO_ACK:
		ret = C.RICcontrolAckRequestVone_noAck
	case e2apies.RiccontrolAckRequest_RICCONTROL_ACK_REQUEST_ACK:
		ret = C.RICcontrolAckRequestVone_ack
	case e2apies.RiccontrolAckRequest_RICCONTROL_ACK_REQUEST_N_ACK:
		ret = C.RICcontrolAckRequestVone_nAck
	default:
...
func decodeRicControlAckRequest(rcarC *C.RICcontrolAckRequestVone_t) e2apies.RiccontrolAckRequest {
