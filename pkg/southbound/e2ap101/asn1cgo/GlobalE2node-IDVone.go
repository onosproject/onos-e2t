...
func xerEncodeGlobalE2nodeID(ge2n *e2apies.GlobalE2NodeId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalE2node_IDVone, unsafe.Pointer(ge2nCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalE2nodeID() %s", err.Error())
	}
	return bytes, nil
...
func PerEncodeGlobalE2nodeID(ge2n *e2apies.GlobalE2NodeId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalE2node_IDVone, unsafe.Pointer(ge2nCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalE2nodeID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalE2nodeID(bytes []byte) (*e2apies.GlobalE2NodeId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalE2node_IDVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalE2NodeID((*C.GlobalE2node_IDVone_t)(unsafePtr))
}

func PerDecodeGlobalE2nodeID(bytes []byte) (*e2apies.GlobalE2NodeId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalE2node_IDVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalE2nodeID(gnID *e2apies.GlobalE2NodeId) (*C.GlobalE2node_IDVone_t, error) {
	var prC C.GlobalE2node_IDVone_PR

	choiceC := [8]byte{} // The size of the GlobalE2node_ID_u
	switch choice := gnID.GetGlobalE2NodeId().(type) {
	case *e2apies.GlobalE2NodeId_GNb:
		prC = C.GlobalE2node_IDVone_PR_gNB
	...
	case *e2apies.GlobalE2NodeId_EnGNb:
		prC = C.GlobalE2node_IDVone_PR_en_gNB
	...
	case *e2apies.GlobalE2NodeId_ENb:
		prC = C.GlobalE2node_IDVone_PR_eNB
	...
	case *e2apies.GlobalE2NodeId_NgENb:
		prC = C.GlobalE2node_IDVone_PR_ng_eNB
...
func decodeGlobalE2NodeID(globalE2nodeID *C.GlobalE2node_IDVone_t) (*e2apies.GlobalE2NodeId, error) {

	result := new(e2apies.GlobalE2NodeId)

	switch globalE2nodeID.present {
	case C.GlobalE2node_IDVone_PR_gNB:
	...
	case C.GlobalE2node_IDVone_PR_en_gNB:
	...
	case C.GlobalE2node_IDVone_PR_eNB:
	...
	case C.GlobalE2node_IDVone_PR_ng_eNB:
...
func decodeGlobalE2NodeIDBytes(globalE2nodeIDchoice [48]byte) (*e2apies.GlobalE2NodeId, error) {
	...
	case C.GlobalE2node_IDVone_PR_gNB:
		...
		gNbC := *(**C.GlobalE2node_gNB_ID_Vone_t)(unsafe.Pointer(&bufC[0]))
	...
	case C.GlobalE2node_IDVone_PR_en_gNB:
		bufC := globalE2nodeIDchoice[8:16]
		enGNbC := *(**C.GlobalE2node_en_gNB_ID_Vone_t)(unsafe.Pointer(&bufC[0]))
	...
	case C.GlobalE2node_IDVone_PR_eNB:
		bufC := globalE2nodeIDchoice[8:16]
		eNbC := *(**C.GlobalE2node_eNB_ID_Vone_t)(unsafe.Pointer(&bufC[0]))
	...
	case C.GlobalE2node_IDVone_PR_ng_eNB:
		bufC := globalE2nodeIDchoice[8:16]
		ngENbC := *(**C.GlobalE2node_ng_eNB_ID_Vone_t)(unsafe.Pointer(&bufC[0]))
