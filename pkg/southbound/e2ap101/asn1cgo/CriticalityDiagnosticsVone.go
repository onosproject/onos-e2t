...
func xerEncodeCriticalityDiagnostics(cd *e2apies.CriticalityDiagnostics) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_CriticalityDiagnosticsVone, unsafe.Pointer(cdCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeCriticalityDiagnostic() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeCriticalityDiagnostics(cd *e2apies.CriticalityDiagnostics) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_CriticalityDiagnosticsVone, unsafe.Pointer(cdCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeCriticalityDiagnostic() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeCriticalityDiagnostics(bytes []byte) (*e2apies.CriticalityDiagnostics, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_CriticalityDiagnosticsVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeCriticalityDiagnostics((*C.CriticalityDiagnosticsVone_t)(unsafePtr))
}

func perDecodeCriticalityDiagnostics(bytes []byte) (*e2apies.CriticalityDiagnostics, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_CriticalityDiagnosticsVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newCriticalityDiagnostics(cd *e2apies.CriticalityDiagnostics) (*C.CriticalityDiagnosticsVone_t, error) {

	var err error
	cdC := C.CriticalityDiagnosticsVone_t{}
...
func decodeCriticalityDiagnosticsBytes(bytes []byte) (*e2apies.CriticalityDiagnostics, error) {
	...
	cdC := C.CriticalityDiagnosticsVone_t{
		...
		ricRequestorID:            (*C.RICrequestIDVone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[24:])))),
		iEsCriticalityDiagnostics: (*C.CriticalityDiagnosticsVone_IE_List_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[32:])))),
	}
	return decodeCriticalityDiagnostics(&cdC)
}

func decodeCriticalityDiagnostics(cdC *C.CriticalityDiagnosticsVone_t) (*e2apies.CriticalityDiagnostics, error) {
