...
func xerEncodeRICcontrolAcknowledge(rca *e2appducontents.RiccontrolAcknowledge) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICcontrolAcknowledgeVone, unsafe.Pointer(rcaC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func xerDecodeRICcontrolAcknowledge(bytes []byte) (*e2appducontents.RiccontrolAcknowledge, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RICcontrolAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicControlAcknowledge((*C.RICcontrolAcknowledgeVone_t)(unsafePtr))
}
...
func perEncodeRICcontrolAcknowledge(rcr *e2appducontents.RiccontrolAcknowledge) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICcontrolAcknowledgeVone, unsafe.Pointer(rcaC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perDecodeRICcontrolAcknowledge(bytes []byte) (*e2appducontents.RiccontrolAcknowledge, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RICcontrolAcknowledgeVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicControlAcknowledge(rca *e2appducontents.RiccontrolAcknowledge) (*C.RICcontrolAcknowledgeVone_t, error) {
...
func decodeRicControlAcknowledge(rcaC *C.RICcontrolAcknowledgeVone_t) (*e2appducontents.RiccontrolAcknowledge, error) {
