...
func newRicSubsequentAction(rsa *e2apies.RicsubsequentAction) (*C.RICsubsequentActionVone_t, error) {
	...
	rsaC := C.RICsubsequentActionVone_t{
...
func decodeRicSubsequentAction(rsaC *C.RICsubsequentActionVone_t) (*e2apies.RicsubsequentAction, error) {
