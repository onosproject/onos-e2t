...
func xerEncodeGlobalE2nodegNBID(ge2n *e2apies.GlobalE2NodeGnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalE2node_gNB_ID_Vone, unsafe.Pointer(ge2nCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalE2nodegNBID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalE2nodegNBID(ge2n *e2apies.GlobalE2NodeGnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalE2node_gNB_ID_Vone, unsafe.Pointer(ge2nCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalE2nodegNBID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalE2nodegNBID(bytes []byte) (*e2apies.GlobalE2NodeGnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalE2node_gNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalE2nodegNBID((*C.GlobalE2node_gNB_ID_Vone_t)(unsafePtr))
}

func perDecodeGlobalE2nodegNBID(bytes []byte) (*e2apies.GlobalE2NodeGnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalE2node_gNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalE2nodegNBID(gnbID *e2apies.GlobalE2NodeGnbId) (*C.GlobalE2node_gNB_ID_Vone_t, error) {
	...
	globalgNBIDC := C.GlobalE2node_gNB_ID_Vone_t{
...
func decodeGlobalE2nodegNBID(gNBC *C.GlobalE2node_gNB_ID_Vone_t) (*e2apies.GlobalE2NodeGnbId, error) {
...
func decodeGlobalE2nodegNBIDBytes(array [8]byte) (*e2apies.GlobalE2NodeGnbId, error) {
	gNBC := (*C.GlobalE2node_gNB_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
