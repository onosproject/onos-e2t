...
func newRicActionNotAdmittedList(ranaL *e2appducontents.RicactionNotAdmittedList) (*C.RICaction_NotAdmitted_List_Vone_t, error) {
	ranaLC := new(C.RICaction_NotAdmitted_List_Vone_t)
...
func decodeRicActionNotAdmittedListBytes(ranaLBytes []byte) (*e2appducontents.RicactionNotAdmittedList, error) {
	...
	ranaLC := C.RICaction_NotAdmitted_List_Vone_t{
		list: C.struct___150{
			array: array,
			size:  size,
			count: count,
...
func decodeRicActionNotAdmittedList(ranaLC *C.RICaction_NotAdmitted_List_Vone_t) (*e2appducontents.RicactionNotAdmittedList, error) {
