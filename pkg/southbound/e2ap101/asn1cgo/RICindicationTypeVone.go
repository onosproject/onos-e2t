...
func newRicIndicationType(rit *e2apies.RicindicationType) (*C.RICindicationTypeVone_t, error) {
	var ret C.RICindicationTypeVone_t
	switch *rit {
	case e2apies.RicindicationType_RICINDICATION_TYPE_REPORT:
		ret = C.RICindicationTypeVone_report
	case e2apies.RicindicationType_RICINDICATION_TYPE_INSERT:
		ret = C.RICindicationTypeVone_insert
	default:
...
func decodeRicIndicationType(ritC *C.RICindicationTypeVone_t) e2apies.RicindicationType {
