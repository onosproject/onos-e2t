...
func xerEncodeE2connectionUpdate(e2connectionUpdate *e2ap_pdu_contents.E2ConnectionUpdate) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateVone, unsafe.Pointer(e2connectionUpdateCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdate() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdate(e2connectionUpdate *e2ap_pdu_contents.E2ConnectionUpdate) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateVone, unsafe.Pointer(e2connectionUpdateCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdate() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdate(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdate, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdate((*C.E2connectionUpdateVone_t)(unsafePtr))
}

func perDecodeE2connectionUpdate(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdate, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdate(e2cu *e2ap_pdu_contents.E2ConnectionUpdate) (*C.E2connectionUpdateVone_t, error) {
...
func decodeE2connectionUpdate(e2cuC *C.E2connectionUpdateVone_t) (*e2ap_pdu_contents.E2ConnectionUpdate, error) {
