...
func xerEncodeE2nodeConfigurationUpdateFailure(e2nodeConfigurationUpdateFailure *e2ap_pdu_contents.E2NodeConfigurationUpdateFailure) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeConfigurationUpdateFailureVone, unsafe.Pointer(e2nodeConfigurationUpdateFailureCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeConfigurationUpdateFailure() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeConfigurationUpdateFailure(e2nodeConfigurationUpdateFailure *e2ap_pdu_contents.E2NodeConfigurationUpdateFailure) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeConfigurationUpdateFailureVone, unsafe.Pointer(e2nodeConfigurationUpdateFailureCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeConfigurationUpdateFailure() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeConfigurationUpdateFailure(bytes []byte) (*e2ap_pdu_contents.E2NodeConfigurationUpdateFailure, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeConfigurationUpdateFailureVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeConfigurationUpdateFailure((*C.E2nodeConfigurationUpdateFailureVone_t)(unsafePtr))
}

func perDecodeE2nodeConfigurationUpdateFailure(bytes []byte) (*e2ap_pdu_contents.E2NodeConfigurationUpdateFailure, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeConfigurationUpdateFailureVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeConfigurationUpdateFailure(e2cuf *e2ap_pdu_contents.E2NodeConfigurationUpdateFailure) (*C.E2nodeConfigurationUpdateFailureVone_t, error) {

	pIeC1710P19, err := newE2nodeConfigurationUpdateFailureIe(e2cuf.ProtocolIes)
	if err != nil {
		return nil, err
	}
	e2cufC := C.E2nodeConfigurationUpdateFailureVone_t{
...
func decodeE2nodeConfigurationUpdateFailure(e2cufC *C.E2nodeConfigurationUpdateFailureVone_t) (*e2ap_pdu_contents.E2NodeConfigurationUpdateFailure, error) {
