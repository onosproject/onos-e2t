...
func xerEncodeE2nodeComponentConfigUpdate(e2nodeComponentConfigUpdate *e2ap_ies.E2NodeComponentConfigUpdate) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateVone, unsafe.Pointer(e2nodeComponentConfigUpdateCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdate() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdate(e2nodeComponentConfigUpdate *e2ap_ies.E2NodeComponentConfigUpdate) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateVone, unsafe.Pointer(e2nodeComponentConfigUpdateCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdate() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdate(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdate, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdate((*C.E2nodeComponentConfigUpdateVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdate(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdate, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdate(e2nodeComponentConfigUpdate *e2ap_ies.E2NodeComponentConfigUpdate) (*C.E2nodeComponentConfigUpdateVone_t, error) {

	var pr C.E2nodeComponentConfigUpdateVone_PR
	choiceC := [8]byte{}
	...
	case *e2ap_ies.E2NodeComponentConfigUpdate_GNbconfigUpdate:
		pr = C.E2nodeComponentConfigUpdateVone_PR_gNBconfigUpdate
	...
	case *e2ap_ies.E2NodeComponentConfigUpdate_EnGNbconfigUpdate:
		pr = C.E2nodeComponentConfigUpdateVone_PR_en_gNBconfigUpdate
	...
	case *e2ap_ies.E2NodeComponentConfigUpdate_NgENbconfigUpdate:
		pr = C.E2nodeComponentConfigUpdateVone_PR_ng_eNBconfigUpdate
	...
	case *e2ap_ies.E2NodeComponentConfigUpdate_ENbconfigUpdate:
		pr = C.E2nodeComponentConfigUpdateVone_PR_eNBconfigUpdate
	...
	e2nodeComponentConfigUpdateC := C.E2nodeComponentConfigUpdateVone_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeE2nodeComponentConfigUpdate(e2nodeComponentConfigUpdateC *C.E2nodeComponentConfigUpdateVone_t) (*e2ap_ies.E2NodeComponentConfigUpdate, error) {

	e2nodeComponentConfigUpdate := new(e2ap_ies.E2NodeComponentConfigUpdate)

	switch e2nodeComponentConfigUpdateC.present {
	case C.E2nodeComponentConfigUpdateVone_PR_gNBconfigUpdate:
	...
	case C.E2nodeComponentConfigUpdateVone_PR_en_gNBconfigUpdate:
	...
	case C.E2nodeComponentConfigUpdateVone_PR_ng_eNBconfigUpdate:
	...
	case C.E2nodeComponentConfigUpdateVone_PR_eNBconfigUpdate:
