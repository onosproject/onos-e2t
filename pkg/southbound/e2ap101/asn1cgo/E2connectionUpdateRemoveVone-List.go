...
func xerEncodeE2connectionUpdateRemoveList(e2connectionUpdateRemoveList *e2ap_pdu_contents.E2ConnectionUpdateRemoveList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateRemoveVone_List, unsafe.Pointer(e2connectionUpdateRemoveListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdateRemoveList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdateRemoveList(e2connectionUpdateRemoveList *e2ap_pdu_contents.E2ConnectionUpdateRemoveList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateRemoveVone_List, unsafe.Pointer(e2connectionUpdateRemoveListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdateRemoveList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdateRemoveList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateRemoveVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdateRemoveList((*C.E2connectionUpdateRemoveVone_List_t)(unsafePtr))
}

func perDecodeE2connectionUpdateRemoveList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateRemoveVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdateRemoveList(e2curl *e2ap_pdu_contents.E2ConnectionUpdateRemoveList) (*C.E2connectionUpdateRemoveVone_List_t, error) {

	e2curlC := new(C.E2connectionUpdateRemoveVone_List_t)
...
func decodeE2connectionUpdateRemoveList(e2curlC *C.E2connectionUpdateRemoveVone_List_t) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveList, error) {
...
func decodeE2connectionUpdateRemoveListBytes(e2curlC [48]byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveList, error) {
	...
	rfIDlC := C.E2connectionUpdateRemoveVone_List_t{
		list: C.struct___97{
			array: array,
			size:  size,
			count: count,
