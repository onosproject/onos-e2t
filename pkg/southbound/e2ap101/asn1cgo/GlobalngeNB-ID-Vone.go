...
func xerEncodeGlobalngeNbID(globalngeNbID *e2ap_ies.GlobalngeNbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalngeNB_ID_Vone, unsafe.Pointer(globalngeNbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalngeNbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalngeNbID(globalngeNbID *e2ap_ies.GlobalngeNbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalngeNB_ID_Vone, unsafe.Pointer(globalngeNbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalngeNbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalngeNbID(bytes []byte) (*e2ap_ies.GlobalngeNbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalngeNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalngeNbID((*C.GlobalngeNB_ID_Vone_t)(unsafePtr))
}

func perDecodeGlobalngeNbID(bytes []byte) (*e2ap_ies.GlobalngeNbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalngeNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalngeNbID(globalngeNbID *e2ap_ies.GlobalngeNbId) (*C.GlobalngeNB_ID_Vone_t, error) {

	var err error
	globalngeNbIDC := C.GlobalngeNB_ID_Vone_t{}
...
func decodeGlobalngeNbID(globalngeNbIDC *C.GlobalngeNB_ID_Vone_t) (*e2ap_ies.GlobalngeNbId, error) {
