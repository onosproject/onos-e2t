...
func xerEncodeE2nodeComponentConfigUpdateGnb(e2nodeComponentConfigUpdateGnb *e2ap_ies.E2NodeComponentConfigUpdateGnb) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateGNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateGnbCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateGnb() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateGnb(e2nodeComponentConfigUpdateGnb *e2ap_ies.E2NodeComponentConfigUpdateGnb) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateGNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateGnbCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateGnb() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateGnb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateGnb, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateGNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateGnb((*C.E2nodeComponentConfigUpdateGNBVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateGnb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateGnb, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateGNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateGnb(e2nodeComponentConfigUpdateGnb *e2ap_ies.E2NodeComponentConfigUpdateGnb) (*C.E2nodeComponentConfigUpdateGNBVone_t, error) {

	e2nodeComponentConfigUpdateGnbC := C.E2nodeComponentConfigUpdateGNBVone_t{}
...
func decodeE2nodeComponentConfigUpdateGnb(e2nodeComponentConfigUpdateGnbC *C.E2nodeComponentConfigUpdateGNBVone_t) (*e2ap_ies.E2NodeComponentConfigUpdateGnb, error) {
...
func decodeE2nodeComponentConfigUpdateGnbBytes(array [8]byte) (*e2ap_ies.E2NodeComponentConfigUpdateGnb, error) {
	e2nodeComponentConfigUpdateGnbC := (*C.E2nodeComponentConfigUpdateGNBVone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
