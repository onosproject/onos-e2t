...
//#include <stdlib.h>
//#include <assert.h>
//#include "E2nodeComponentGNB-CU-UP-ID-Vone.h"
import "C"
...
func xerEncodeE2nodeComponentGnbCuUpID(e2nodeComponentGnbCuUpID *e2ap_ies.E2NodeComponentGnbCuUpId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentGNB_CU_UP_ID_Vone, unsafe.Pointer(e2nodeComponentGnbCuUpIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentGnbCuUpID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentGnbCuUpID(e2nodeComponentGnbCuUpID *e2ap_ies.E2NodeComponentGnbCuUpId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentGNB_CU_UP_ID_Vone, unsafe.Pointer(e2nodeComponentGnbCuUpIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentGnbCuUpID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentGnbCuUpID(bytes []byte) (*e2ap_ies.E2NodeComponentGnbCuUpId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentGNB_CU_UP_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentGnbCuUpID((*C.E2nodeComponentGNB_CU_UP_ID_Vone_t)(unsafePtr))
}

func perDecodeE2nodeComponentGnbCuUpID(bytes []byte) (*e2ap_ies.E2NodeComponentGnbCuUpId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentGNB_CU_UP_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentGnbCuUpID(e2nodeComponentGnbCuUpID *e2ap_ies.E2NodeComponentGnbCuUpId) (*C.E2nodeComponentGNB_CU_UP_ID_Vone_t, error) {

	var err error
	e2nodeComponentGnbCuUpIDC := C.E2nodeComponentGNB_CU_UP_ID_Vone_t{}
...
func decodeE2nodeComponentGnbCuUpID(e2nodeComponentGnbCuUpIDC *C.E2nodeComponentGNB_CU_UP_ID_Vone_t) (*e2ap_ies.E2NodeComponentGnbCuUpId, error) {
...
func decodeE2nodeComponentGnbCuUpIDBytes(array [8]byte) (*e2ap_ies.E2NodeComponentGnbCuUpId, error) {
	e2nodeComponentGnbCuUpIDC := (*C.E2nodeComponentGNB_CU_UP_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
