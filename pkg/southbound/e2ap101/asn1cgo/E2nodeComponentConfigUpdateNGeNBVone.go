...
func xerEncodeE2nodeComponentConfigUpdateNgeNb(e2nodeComponentConfigUpdateNgeNb *e2ap_ies.E2NodeComponentConfigUpdateNgeNb) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateNGeNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateNgeNbCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateNgeNb() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateNgeNb(e2nodeComponentConfigUpdateNgeNb *e2ap_ies.E2NodeComponentConfigUpdateNgeNb) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateNGeNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateNgeNbCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateNgeNb() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateNgeNb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateNgeNb, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateNGeNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateNgeNb((*C.E2nodeComponentConfigUpdateNGeNBVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateNgeNb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateNgeNb, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateNGeNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateNgeNb(e2nodeComponentConfigUpdateNgeNb *e2ap_ies.E2NodeComponentConfigUpdateNgeNb) (*C.E2nodeComponentConfigUpdateNGeNBVone_t, error) {

	e2nodeComponentConfigUpdateNgeNbC := C.E2nodeComponentConfigUpdateNGeNBVone_t{}
...
func decodeE2nodeComponentConfigUpdateNgeNb(e2nodeComponentConfigUpdateNgeNbC *C.E2nodeComponentConfigUpdateNGeNBVone_t) (*e2ap_ies.E2NodeComponentConfigUpdateNgeNb, error) {
...
func decodeE2nodeComponentConfigUpdateNgeNbBytes(array [8]byte) (*e2ap_ies.E2NodeComponentConfigUpdateNgeNb, error) {
	e2nodeComponentConfigUpdateNgeNbC := (*C.E2nodeComponentConfigUpdateNGeNBVone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
