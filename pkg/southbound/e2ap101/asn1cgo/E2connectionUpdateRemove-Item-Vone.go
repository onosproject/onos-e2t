...
func xerEncodeE2connectionUpdateRemoveItem(e2connectionUpdateRemoveItem *e2ap_pdu_contents.E2ConnectionUpdateRemoveItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateRemove_Item_Vone, unsafe.Pointer(e2connectionUpdateRemoveItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdateRemoveItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdateRemoveItem(e2connectionUpdateRemoveItem *e2ap_pdu_contents.E2ConnectionUpdateRemoveItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateRemove_Item_Vone, unsafe.Pointer(e2connectionUpdateRemoveItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdateRemoveItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdateRemoveItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateRemove_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdateRemoveItem((*C.E2connectionUpdateRemove_Item_Vone_t)(unsafePtr))
}

func perDecodeE2connectionUpdateRemoveItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateRemove_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdateRemoveItem(e2connectionUpdateRemoveItem *e2ap_pdu_contents.E2ConnectionUpdateRemoveItem) (*C.E2connectionUpdateRemove_Item_Vone_t, error) {

	var err error
	e2connectionUpdateRemoveItemC := C.E2connectionUpdateRemove_Item_Vone_t{}
...
func decodeE2connectionUpdateRemoveItem(e2connectionUpdateRemoveItemC *C.E2connectionUpdateRemove_Item_Vone_t) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveItem, error) {
...
func decodeE2connectionUpdateRemoveItemBytes(array [104]byte) (*e2ap_pdu_contents.E2ConnectionUpdateRemoveItem, error) {
	...
	e2csfItemC := C.E2connectionUpdateRemove_Item_Vone_t{
