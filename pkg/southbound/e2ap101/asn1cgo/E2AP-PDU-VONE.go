...
func XerDecodeE2apPdu(bytes []byte) (*e2appdudescriptions.E2ApPdu, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2AP_PDU_VONE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2apPdu((*C.E2AP_PDU_VONE_t)(unsafePtr))
}
...
func PerDecodeE2apPdu(bytes []byte) (*e2appdudescriptions.E2ApPdu, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2AP_PDU_VONE)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func XerEncodeE2apPdu(e2apPdu *e2appdudescriptions.E2ApPdu) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2AP_PDU_VONE, unsafe.Pointer(cE2apPdu))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func PerEncodeE2apPdu(e2apPdu *e2appdudescriptions.E2ApPdu) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2AP_PDU_VONE, unsafe.Pointer(cE2apPdu))
	if err != nil {
		return nil, err
	}
...
func newE2apPdu(e2apPdu *e2appdudescriptions.E2ApPdu) (*C.E2AP_PDU_VONE_t, error) {
	var present C.E2AP_PDU_VONE_PR
	choiceC := [8]byte{}

	switch choice := e2apPdu.E2ApPdu.(type) {
	case *e2appdudescriptions.E2ApPdu_InitiatingMessage:
		present = C.E2AP_PDU_VONE_PR_initiatingMessage
	...
	case *e2appdudescriptions.E2ApPdu_SuccessfulOutcome:
		present = C.E2AP_PDU_VONE_PR_successfulOutcome
	...
	case *e2appdudescriptions.E2ApPdu_UnsuccessfulOutcome:
		present = C.E2AP_PDU_VONE_PR_unsuccessfulOutcome
...
func decodeE2apPdu(e2apPduC *C.E2AP_PDU_VONE_t) (*e2appdudescriptions.E2ApPdu, error) {
	e2apPdu := new(e2appdudescriptions.E2ApPdu)
	switch e2apPduC.present {
	case C.E2AP_PDU_VONE_PR_initiatingMessage:
		// https://sunzenshen.github.io/tutorials/2015/05/09/cgotchas-intro.html
		initMsgC := *(**C.InitiatingMessageVone_t)(unsafe.Pointer(&e2apPduC.choice[0]))
	...
	case C.E2AP_PDU_VONE_PR_successfulOutcome:
		// https://sunzenshen.github.io/tutorials/2015/05/09/cgotchas-intro.html
		soC := *(**C.SuccessfulOutcomeVone_t)(unsafe.Pointer(&e2apPduC.choice[0]))
	...
	case C.E2AP_PDU_VONE_PR_unsuccessfulOutcome:
		// https://sunzenshen.github.io/tutorials/2015/05/09/cgotchas-intro.html
		usoC := *(**C.UnsuccessfulOutcomeVone_t)(unsafe.Pointer(&e2apPduC.choice[0]))
