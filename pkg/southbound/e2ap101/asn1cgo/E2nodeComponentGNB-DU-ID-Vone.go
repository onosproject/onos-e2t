...
//#include <stdlib.h>
//#include <assert.h>
//#include "E2nodeComponentGNB-DU-ID-Vone.h"
import "C"
...
func xerEncodeE2nodeComponentGnbDuID(e2nodeComponentGnbDuID *e2ap_ies.E2NodeComponentGnbDuId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentGNB_DU_ID_Vone, unsafe.Pointer(e2nodeComponentGnbDuIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentGnbDuID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentGnbDuID(e2nodeComponentGnbDuID *e2ap_ies.E2NodeComponentGnbDuId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentGNB_DU_ID_Vone, unsafe.Pointer(e2nodeComponentGnbDuIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentGnbDuID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentGnbDuID(bytes []byte) (*e2ap_ies.E2NodeComponentGnbDuId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentGNB_DU_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentGnbDuID((*C.E2nodeComponentGNB_DU_ID_Vone_t)(unsafePtr))
}

func perDecodeE2nodeComponentGnbDuID(bytes []byte) (*e2ap_ies.E2NodeComponentGnbDuId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentGNB_DU_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentGnbDuID(e2nodeComponentGnbDuID *e2ap_ies.E2NodeComponentGnbDuId) (*C.E2nodeComponentGNB_DU_ID_Vone_t, error) {

	var err error
	e2nodeComponentGnbDuIDC := C.E2nodeComponentGNB_DU_ID_Vone_t{}
...
func decodeE2nodeComponentGnbDuID(e2nodeComponentGnbDuIDC *C.E2nodeComponentGNB_DU_ID_Vone_t) (*e2ap_ies.E2NodeComponentGnbDuId, error) {
...
func decodeE2nodeComponentGnbDuIDBytes(array [8]byte) (*e2ap_ies.E2NodeComponentGnbDuId, error) {
	e2nodeComponentGnbDuIDC := (*C.E2nodeComponentGNB_DU_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
