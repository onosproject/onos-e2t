...
func xerEncodeRicActionToBeSetupItem(ratbsi *e2appducontents.RicactionToBeSetupItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICaction_ToBeSetup_Item_Vone, unsafe.Pointer(ratbsiCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeRicActionToBeSetupItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeRicActionToBeSetupItem(ratbsi *e2appducontents.RicactionToBeSetupItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICaction_ToBeSetup_Item_Vone, unsafe.Pointer(ratbsiCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeRicActionToBeSetupItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeRicActionToBeSetupItem(bytes []byte) (*e2appducontents.RicactionToBeSetupItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RICaction_ToBeSetup_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicActionToBeSetupItem((*C.RICaction_ToBeSetup_Item_Vone_t)(unsafePtr))
}

func perDecodeRicActionToBeSetupItem(bytes []byte) (*e2appducontents.RicactionToBeSetupItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RICaction_ToBeSetup_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicActionToBeSetupItem(ratbsItem *e2appducontents.RicactionToBeSetupItem) (*C.RICaction_ToBeSetup_Item_Vone_t, error) {
	ratC, err := newRicActionType(ratbsItem.GetRicActionType())
	if err != nil {
		return nil, fmt.Errorf("newRicActionType() %s", err.Error())
	}

	ratbsItemC := C.RICaction_ToBeSetup_Item_Vone_t{
...
func decodeRicActionToBeSetupItemBytes(bytes [56]byte) (*e2appducontents.RicactionToBeSetupItem, error) {
	...
	rfiC := C.RICaction_ToBeSetup_Item_Vone_t{
		ricActionID:         C.long(binary.LittleEndian.Uint64(bytes[:8])),
		ricActionType:       C.long(binary.LittleEndian.Uint64(bytes[8:16])),
		ricActionDefinition: (*C.RICactionDefinitionVone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[16:24])))),
		ricSubsequentAction: (*C.struct_RICsubsequentActionVone)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(bytes[24:32])))),
	}

	return decodeRicActionToBeSetupItem(&rfiC)
}

func decodeRicActionToBeSetupItem(rfiC *C.RICaction_ToBeSetup_Item_Vone_t) (*e2appducontents.RicactionToBeSetupItem, error) {
