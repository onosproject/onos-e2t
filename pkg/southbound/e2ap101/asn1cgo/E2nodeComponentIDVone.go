...
func xerEncodeE2nodeComponentID(e2nodeComponentID *e2ap_ies.E2NodeComponentId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentIDVone, unsafe.Pointer(e2nodeComponentIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentID(e2nodeComponentID *e2ap_ies.E2NodeComponentId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentIDVone, unsafe.Pointer(e2nodeComponentIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentID(bytes []byte) (*e2ap_ies.E2NodeComponentId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentIDVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentID((*C.E2nodeComponentIDVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentID(bytes []byte) (*e2ap_ies.E2NodeComponentId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentIDVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentID(e2nodeComponentID *e2ap_ies.E2NodeComponentId) (*C.E2nodeComponentIDVone_t, error) {

	var pr C.E2nodeComponentIDVone_PR
	choiceC := [8]byte{}

	switch choice := e2nodeComponentID.E2NodeComponentId.(type) {
	case *e2ap_ies.E2NodeComponentId_E2NodeComponentTypeGnbCuUp:
		pr = C.E2nodeComponentIDVone_PR_e2nodeComponentTypeGNB_CU_UP
	...
	case *e2ap_ies.E2NodeComponentId_E2NodeComponentTypeGnbDu:
		pr = C.E2nodeComponentIDVone_PR_e2nodeComponentTypeGNB_DU
	...
	e2nodeComponentIDC := C.E2nodeComponentIDVone_t{
		present: pr,
		choice:  choiceC,
	}
...
func decodeE2nodeComponentID(e2nodeComponentIDC *C.E2nodeComponentIDVone_t) (*e2ap_ies.E2NodeComponentId, error) {

	e2nodeComponentID := new(e2ap_ies.E2NodeComponentId)

	switch e2nodeComponentIDC.present {
	case C.E2nodeComponentIDVone_PR_e2nodeComponentTypeGNB_CU_UP:
	...
	case C.E2nodeComponentIDVone_PR_e2nodeComponentTypeGNB_DU:
