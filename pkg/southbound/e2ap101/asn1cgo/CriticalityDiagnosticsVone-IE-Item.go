...
func newCriticalityDiagnosticsIEItem(cdIeI *e2apies.CriticalityDiagnosticsIeItem) (*C.CriticalityDiagnosticsVone_IE_Item_t, error) {
	...
	cdIeIC := C.CriticalityDiagnosticsVone_IE_Item_t{
		iECriticality: c,
		iE_ID:         p,
		typeOfError:   t,
	}
...
func decodeCriticalityDiagnosticsIEItem(cdIC *C.CriticalityDiagnosticsVone_IE_Item_t) (*e2apies.CriticalityDiagnosticsIeItem, error) {
