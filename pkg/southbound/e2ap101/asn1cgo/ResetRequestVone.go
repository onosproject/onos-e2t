...
func xerEncodeResetRequest(rr *e2ap_pdu_contents.ResetRequest) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_ResetRequestVone, unsafe.Pointer(rrCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeResetRequest() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeResetRequest(rr *e2ap_pdu_contents.ResetRequest) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_ResetRequestVone, unsafe.Pointer(rrCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeResetRequest() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeResetRequest(bytes []byte) (*e2ap_pdu_contents.ResetRequest, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_ResetRequestVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeResetRequest((*C.ResetRequestVone_t)(unsafePtr))
}

func perDecodeResetRequest(bytes []byte) (*e2ap_pdu_contents.ResetRequest, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_ResetRequestVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newResetRequest(rr *e2ap_pdu_contents.ResetRequest) (*C.ResetRequestVone_t, error) {
...
func decodeResetRequest(rrC *C.ResetRequestVone_t) (*e2ap_pdu_contents.ResetRequest, error) {
