...
//#include <stdlib.h>
//#include <assert.h>
//#include "E2nodeComponentConfigUpdateAckVone.h"
import "C"
...
func xerEncodeE2nodeComponentConfigUpdateAck(e2nodeComponentConfigUpdateAck *e2ap_ies.E2NodeComponentConfigUpdateAck) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone, unsafe.Pointer(e2nodeComponentConfigUpdateAckCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateAck() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateAck(e2nodeComponentConfigUpdateAck *e2ap_ies.E2NodeComponentConfigUpdateAck) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone, unsafe.Pointer(e2nodeComponentConfigUpdateAckCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateAck() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateAck(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateAck, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateAckVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateAck((*C.E2nodeComponentConfigUpdateAckVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateAck(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateAck, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateAckVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateAck(e2nodeComponentConfigUpdateAck *e2ap_ies.E2NodeComponentConfigUpdateAck) (*C.E2nodeComponentConfigUpdateAckVone_t, error) {

	e2nodeComponentConfigUpdateAckC := C.E2nodeComponentConfigUpdateAckVone_t{}
...
func decodeE2nodeComponentConfigUpdateAck(e2nodeComponentConfigUpdateAckC *C.E2nodeComponentConfigUpdateAckVone_t) (*e2ap_ies.E2NodeComponentConfigUpdateAck, error) {
