...
func newRicControlMessage(rcm *e2ap_commondatatypes.RiccontrolMessage) *C.RICcontrolMessageVone_t {
...
func decodeRicControlMessage(rcmC *C.RICcontrolMessageVone_t) *e2ap_commondatatypes.RiccontrolMessage {
