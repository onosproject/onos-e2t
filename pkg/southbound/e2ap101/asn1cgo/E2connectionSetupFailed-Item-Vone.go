...
func xerEncodeE2connectionSetupFailedItem(e2connectionSetupFailedItem *e2ap_pdu_contents.E2ConnectionSetupFailedItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionSetupFailed_Item_Vone, unsafe.Pointer(e2connectionSetupFailedItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionSetupFailedItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionSetupFailedItem(e2connectionSetupFailedItem *e2ap_pdu_contents.E2ConnectionSetupFailedItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionSetupFailed_Item_Vone, unsafe.Pointer(e2connectionSetupFailedItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionSetupFailedItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionSetupFailedItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionSetupFailed_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionSetupFailedItem((*C.E2connectionSetupFailed_Item_Vone_t)(unsafePtr))
}

func perDecodeE2connectionSetupFailedItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionSetupFailed_Item_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionSetupFailedItem(e2connectionSetupFailedItem *e2ap_pdu_contents.E2ConnectionSetupFailedItem) (*C.E2connectionSetupFailed_Item_Vone_t, error) {

	var err error
	e2connectionSetupFailedItemC := C.E2connectionSetupFailed_Item_Vone_t{}
...
func decodeE2connectionSetupFailedItem(e2connectionSetupFailedItemC *C.E2connectionSetupFailed_Item_Vone_t) (*e2ap_pdu_contents.E2ConnectionSetupFailedItem, error) {
...
func decodeE2connectionSetupFailedItemBytes(array [144]byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedItem, error) {
	...
	e2csfItemC := C.E2connectionSetupFailed_Item_Vone_t{
		tnlInformation: C.TNLinformationVone_t{
		...
		cause: C.CauseVone_t{
			present: C.CauseVone_PR(binary.LittleEndian.Uint64(array[80:])),
		},
	}
