...
func xerEncodeE2connectionUpdateItem(e2connectionUpdateItem *e2ap_pdu_contents.E2ConnectionUpdateItem) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateVone_Item, unsafe.Pointer(e2connectionUpdateItemCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdateItem() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdateItem(e2connectionUpdateItem *e2ap_pdu_contents.E2ConnectionUpdateItem) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateVone_Item, unsafe.Pointer(e2connectionUpdateItemCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdateItem() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdateItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateItem, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdateItem((*C.E2connectionUpdateVone_Item_t)(unsafePtr))
}

func perDecodeE2connectionUpdateItem(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateItem, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateVone_Item)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdateItem(e2connectionUpdateItem *e2ap_pdu_contents.E2ConnectionUpdateItem) (*C.E2connectionUpdateVone_Item_t, error) {

	var err error
	e2connectionUpdateItemC := C.E2connectionUpdateVone_Item_t{}
...
func decodeE2connectionUpdateItem(e2connectionUpdateItemC *C.E2connectionUpdateVone_Item_t) (*e2ap_pdu_contents.E2ConnectionUpdateItem, error) {
...
func decodeE2connectionUpdateItemBytes(array [112]byte) (*e2ap_pdu_contents.E2ConnectionUpdateItem, error) {
	...
	e2cuItemC := C.E2connectionUpdateVone_Item_t{
