...
func xerEncodeE2SetupRequest(e2SetupRequest *e2appducontents.E2SetupRequest) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2setupRequestVone, unsafe.Pointer(e2SetupRequestC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perEncodeE2SetupRequest(e2SetupRequest *e2appducontents.E2SetupRequest) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2setupRequestVone, unsafe.Pointer(e2SetupRequestC))
	if err != nil {
		return nil, err
	}
...
func newE2SetupRequest(esr *e2appducontents.E2SetupRequest) (*C.E2setupRequestVone_t, error) {
...
func decodeE2setupRequest(e2setupRequestC *C.E2setupRequestVone_t) (*e2appducontents.E2SetupRequest, error) {
