...
func newGlobalRicID(gr *e2apies.GlobalRicId) (*C.GlobalRIC_IDVone_t, error) {
...
func decodeGlobalRicID(grID *C.GlobalRIC_IDVone_t) (*e2apies.GlobalRicId, error) {
