...
func xerEncodeE2nodeComponentConfigUpdateAckList(e2nodeComponentConfigUpdateAckList *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone_List, unsafe.Pointer(e2nodeComponentConfigUpdateAckListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateAckList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateAckList(e2nodeComponentConfigUpdateAckList *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateAckVone_List, unsafe.Pointer(e2nodeComponentConfigUpdateAckListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateAckList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateAckList(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateAckVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateAckList((*C.E2nodeComponentConfigUpdateAckVone_List_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateAckList(bytes []byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateAckVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateAckList(e2nodeComponentConfigUpdateAckList *e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList) (*C.E2nodeComponentConfigUpdateAckVone_List_t, error) {

	e2nodeComponentConfigUpdateAckListC := new(C.E2nodeComponentConfigUpdateAckVone_List_t)
...
func decodeE2nodeComponentConfigUpdateAckList(e2nodeComponentConfigUpdateAckListC *C.E2nodeComponentConfigUpdateAckVone_List_t) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList, error) {
...
func decodeE2nodeComponentConfigUpdateAckListBytes(e2nccualC [112]byte) (*e2ap_pdu_contents.E2NodeComponentConfigUpdateAckList, error) {
	...
	rfIDlC := C.E2nodeComponentConfigUpdateAckVone_List_t{
		list: C.struct___141{
			array: array,
			size:  size,
			count: count,
