...
func xerEncodeGlobalE2nodeEnGnbID(globalE2nodeEnGnbID *e2ap_ies.GlobalE2NodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_GlobalE2node_en_gNB_ID_Vone, unsafe.Pointer(globalE2nodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeGlobalE2nodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeGlobalE2nodeEnGnbID(globalE2nodeEnGnbID *e2ap_ies.GlobalE2NodeEnGnbId) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_GlobalE2node_en_gNB_ID_Vone, unsafe.Pointer(globalE2nodeEnGnbIDCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeGlobalE2nodeEnGnbID() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeGlobalE2nodeEnGnbID(bytes []byte) (*e2ap_ies.GlobalE2NodeEnGnbId, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_GlobalE2node_en_gNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeGlobalE2nodeEnGnbID((*C.GlobalE2node_en_gNB_ID_Vone_t)(unsafePtr))
}

func perDecodeGlobalE2nodeEnGnbID(bytes []byte) (*e2ap_ies.GlobalE2NodeEnGnbId, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_GlobalE2node_en_gNB_ID_Vone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newGlobalE2nodeEnGnbID(globalE2nodeEnGnbID *e2ap_ies.GlobalE2NodeEnGnbId) (*C.GlobalE2node_en_gNB_ID_Vone_t, error) {

	var err error
	globalE2nodeEnGnbIDC := C.GlobalE2node_en_gNB_ID_Vone_t{}
...
func decodeGlobalE2nodeEnGnbID(globalE2nodeEnGnbIDC *C.GlobalE2node_en_gNB_ID_Vone_t) (*e2ap_ies.GlobalE2NodeEnGnbId, error) {
...
func decodeGlobalE2nodeEnGnbIDBytes(array [8]byte) (*e2ap_ies.GlobalE2NodeEnGnbId, error) {
	globalE2nodeEnGnbIDC := (*C.GlobalE2node_en_gNB_ID_Vone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
