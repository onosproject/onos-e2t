...
func newRicActionID(raID *e2apies.RicactionId) *C.RICactionIDVone_t {
	raIDC := C.RICactionIDVone_t(raID.GetValue())
	return &raIDC
}
...
func decodeRicActionID(raIDC *C.RICactionIDVone_t) *e2apies.RicactionId {
