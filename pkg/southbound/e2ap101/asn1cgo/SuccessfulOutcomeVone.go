...
//#include <stdlib.h>
//#include <assert.h>
//#include "SuccessfulOutcomeVone.h"
...
func newSuccessfulOutcome(so *e2appdudescriptions.SuccessfulOutcome) (*C.SuccessfulOutcomeVone_t, error) {
	var presentC C.SuccessfulOutcomeVone__value_PR
	...
	if pc := so.GetProcedureCode().GetE2Setup(); pc != nil &&
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_E2setupResponseVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_RICsubscriptionResponseVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_RICsubscriptionDeleteResponseVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_RICcontrolAcknowledgeVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_ResetResponseVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_RICserviceUpdateAcknowledgeVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_E2nodeConfigurationUpdateAcknowledgeVone
		...
		presentC = C.SuccessfulOutcomeVone__value_PR_E2connectionUpdateAcknowledgeVone
	...
	sovC := C.struct_SuccessfulOutcomeVone__value{
		present: presentC,
		choice:  choiceC,
	}

	soC := C.SuccessfulOutcomeVone_t{
		procedureCode: pcC,
		criticality:   critC,
		value:         sovC,
	}
...
func decodeSuccessfulOutcome(successC *C.SuccessfulOutcomeVone_t) (*e2appdudescriptions.SuccessfulOutcome, error) {
	...
	case C.SuccessfulOutcomeVone__value_PR_RICsubscriptionResponseVone:
		rsrespC := C.RICsubscriptionResponseVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P1_t{
				list: C.struct___135{ // TODO: tie this down with a predictable name
					array: (**C.RICsubscriptionResponseVone_IEs_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_E2setupResponseVone:
		e2SrC := C.E2setupResponseVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P12_t{
				list: C.struct___134{ // TODO: tie this down with a predictable name
					array: (**C.E2setupResponseIEsVone_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_RICsubscriptionDeleteResponseVone:
		rsdrC := C.RICsubscriptionDeleteResponseVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P4_t{
				list: C.struct___138{ // TODO: tie this down with a predictable name
					array: (**C.RICsubscriptionDeleteResponseVone_IEs_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_RICcontrolAcknowledgeVone:
		rcaC := C.RICcontrolAcknowledgeVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P8_t{
				list: C.struct___139{ // TODO: tie this down with a predictable name
					array: (**C.RICcontrolAcknowledgeVone_IEs_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_ResetResponseVone:
		rrC := C.ResetResponseVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P21_t{
				list: C.struct___136{ // TODO: tie this down with a predictable name
					array: (**C.ResetResponseIEsVone_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_RICserviceUpdateAcknowledgeVone:
		rsuaC := C.RICserviceUpdateAcknowledgeVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P23_t{
				list: C.struct___137{ // TODO: tie this down with a predictable name
					array: (**C.RICserviceUpdateAcknowledgeVone_IEs_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_E2nodeConfigurationUpdateAcknowledgeVone:
		e2ncuaC := C.E2nodeConfigurationUpdateAcknowledgeVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P18_t{
				list: C.struct___133{ // TODO: tie this down with a predictable name
					array: (**C.E2nodeConfigurationUpdateAcknowledgeVone_IEs_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
	...
	case C.SuccessfulOutcomeVone__value_PR_E2connectionUpdateAcknowledgeVone:
		e2cuaC := C.E2connectionUpdateAcknowledgeVone_t{
			protocolIEs: C.ProtocolIE_Container_1710P15_t{
				list: C.struct___132{ // TODO: tie this down with a predictable name
					array: (**C.E2connectionUpdateAck_IEs_Vone_t)(listArrayAddr),
					count: count,
					size:  size,
				},
			},
