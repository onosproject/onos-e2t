...
func newRanFunctionIDItem(rfIDi *e2appducontents.RanfunctionIdItem) *C.RANfunctionIDVone_Item_t {
	rfIDiC := C.RANfunctionIDVone_Item_t{
...
func decodeRanFunctionIDItemBytes(bytes [40]byte) (*e2appducontents.RanfunctionIdItem, error) {
	rfiC := C.RANfunctionIDVone_Item_t{
...
func decodeRanFunctionIDItem(rfiC *C.RANfunctionIDVone_Item_t) (*e2appducontents.RanfunctionIdItem, error) {
