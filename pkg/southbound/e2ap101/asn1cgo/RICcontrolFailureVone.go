...
func xerEncodeRICcontrolFailure(rcf *e2appducontents.RiccontrolFailure) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_RICcontrolFailureVone, unsafe.Pointer(rcfC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func xerDecodeRICcontrolFailure(bytes []byte) (*e2appducontents.RiccontrolFailure, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_RICcontrolFailureVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeRicControlFailure((*C.RICcontrolFailureVone_t)(unsafePtr))
}
...
func perEncodeRICcontrolFailure(rcf *e2appducontents.RiccontrolFailure) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_RICcontrolFailureVone, unsafe.Pointer(rcfC))
	if err != nil {
		return nil, err
	}
	return bytes, nil
...
func perDecodeRICcontrolFailure(bytes []byte) (*e2appducontents.RiccontrolFailure, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_RICcontrolFailureVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newRicControlFailure(rcf *e2appducontents.RiccontrolFailure) (*C.RICcontrolFailureVone_t, error) {
...
func decodeRicControlFailure(rcfC *C.RICcontrolFailureVone_t) (*e2appducontents.RiccontrolFailure, error) {
