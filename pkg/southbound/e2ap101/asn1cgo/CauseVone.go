...
func decodeCauseBytes(bytes []byte) (*e2apies.Cause, error) {
	causeC := C.CauseVone_t{
		present: C.CauseVone_PR(binary.LittleEndian.Uint64(bytes[:8])),
	}
