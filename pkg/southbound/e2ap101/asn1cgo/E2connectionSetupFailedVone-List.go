...
func xerEncodeE2connectionSetupFailedList(e2connectionSetupFailedList *e2ap_pdu_contents.E2ConnectionSetupFailedList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionSetupFailedVone_List, unsafe.Pointer(e2connectionSetupFailedListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionSetupFailedList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionSetupFailedList(e2connectionSetupFailedList *e2ap_pdu_contents.E2ConnectionSetupFailedList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionSetupFailedVone_List, unsafe.Pointer(e2connectionSetupFailedListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionSetupFailedList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionSetupFailedList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionSetupFailedVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionSetupFailedList((*C.E2connectionSetupFailedVone_List_t)(unsafePtr))
}

func perDecodeE2connectionSetupFailedList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionSetupFailedVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionSetupFailedList(e2connectionSetupFailedList *e2ap_pdu_contents.E2ConnectionSetupFailedList) (*C.E2connectionSetupFailedVone_List_t, error) {

	e2connectionSetupFailedListC := new(C.E2connectionSetupFailedVone_List_t)
...
func decodeE2connectionSetupFailedList(e2connectionSetupFailedListC *C.E2connectionSetupFailedVone_List_t) (*e2ap_pdu_contents.E2ConnectionSetupFailedList, error) {
...
func decodeE2connectionSetupFailedListBytes(e2cuflC [48]byte) (*e2ap_pdu_contents.E2ConnectionSetupFailedList, error) {
	...
	e2csflC := C.E2connectionSetupFailedVone_List_t{
		list: C.struct___141{
			array: array,
			size:  size,
			count: count,
