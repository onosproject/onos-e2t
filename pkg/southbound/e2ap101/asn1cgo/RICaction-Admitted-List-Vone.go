...
func newRicActionAdmittedList(raal *e2appducontents.RicactionAdmittedList) (*C.RICaction_Admitted_List_Vone_t, error) {
	rfIDlC := new(C.RICaction_Admitted_List_Vone_t)
...
func decodeRicActionAdmittedListBytes(raalBytes []byte) (*e2appducontents.RicactionAdmittedList, error) {
	...
	raalC := C.RICaction_Admitted_List_Vone_t{
		list: C.struct___141{
			array: array,
			size:  size,
			count: count,
...
func decodeRicActionAdmittedList(raalC *C.RICaction_Admitted_List_Vone_t) (*e2appducontents.RicactionAdmittedList, error) {
