...
func xerEncodeE2connectionUpdateList(e2connectionUpdateList *e2ap_pdu_contents.E2ConnectionUpdateList) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2connectionUpdateVone_List, unsafe.Pointer(e2connectionUpdateListCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2connectionUpdateList() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2connectionUpdateList(e2connectionUpdateList *e2ap_pdu_contents.E2ConnectionUpdateList) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2connectionUpdateVone_List, unsafe.Pointer(e2connectionUpdateListCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2connectionUpdateList() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2connectionUpdateList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateList, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2connectionUpdateVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2connectionUpdateList((*C.E2connectionUpdateVone_List_t)(unsafePtr))
}

func perDecodeE2connectionUpdateList(bytes []byte) (*e2ap_pdu_contents.E2ConnectionUpdateList, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2connectionUpdateVone_List)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2connectionUpdateList(e2cul *e2ap_pdu_contents.E2ConnectionUpdateList) (*C.E2connectionUpdateVone_List_t, error) {

	e2culC := new(C.E2connectionUpdateVone_List_t)
...
func decodeE2connectionUpdateList(e2culC *C.E2connectionUpdateVone_List_t) (*e2ap_pdu_contents.E2ConnectionUpdateList, error) {
...
func decodeE2connectionUpdateListBytes(e2curlC [48]byte) (*e2ap_pdu_contents.E2ConnectionUpdateList, error) {
	...
	rfIDlC := C.E2connectionUpdateVone_List_t{
		list: C.struct___141{
			array: array,
			size:  size,
			count: count,
