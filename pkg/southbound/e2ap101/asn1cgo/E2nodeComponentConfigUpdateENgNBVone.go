...
func xerEncodeE2nodeComponentConfigUpdateEngNb(e2nodeComponentConfigUpdateEngNb *e2ap_ies.E2NodeComponentConfigUpdateEngNb) ([]byte, error) {
	...
	bytes, err := encodeXer(&C.asn_DEF_E2nodeComponentConfigUpdateENgNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateEngNbCP))
	if err != nil {
		return nil, fmt.Errorf("xerEncodeE2nodeComponentConfigUpdateEngNb() %s", err.Error())
	}
	return bytes, nil
...
func perEncodeE2nodeComponentConfigUpdateEngNb(e2nodeComponentConfigUpdateEngNb *e2ap_ies.E2NodeComponentConfigUpdateEngNb) ([]byte, error) {
	...
	bytes, err := encodePerBuffer(&C.asn_DEF_E2nodeComponentConfigUpdateENgNBVone, unsafe.Pointer(e2nodeComponentConfigUpdateEngNbCP))
	if err != nil {
		return nil, fmt.Errorf("perEncodeE2nodeComponentConfigUpdateEngNb() %s", err.Error())
	}
	return bytes, nil
...
func xerDecodeE2nodeComponentConfigUpdateEngNb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateEngNb, error) {
	unsafePtr, err := decodeXer(bytes, &C.asn_DEF_E2nodeComponentConfigUpdateENgNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
	...
	return decodeE2nodeComponentConfigUpdateEngNb((*C.E2nodeComponentConfigUpdateENgNBVone_t)(unsafePtr))
}

func perDecodeE2nodeComponentConfigUpdateEngNb(bytes []byte) (*e2ap_ies.E2NodeComponentConfigUpdateEngNb, error) {
	unsafePtr, err := decodePer(bytes, len(bytes), &C.asn_DEF_E2nodeComponentConfigUpdateENgNBVone)
	if err != nil {
		return nil, err
	}
	if unsafePtr == nil {
...
func newE2nodeComponentConfigUpdateEngNb(e2nodeComponentConfigUpdateEngNb *e2ap_ies.E2NodeComponentConfigUpdateEngNb) (*C.E2nodeComponentConfigUpdateENgNBVone_t, error) {

	e2nodeComponentConfigUpdateEngNbC := C.E2nodeComponentConfigUpdateENgNBVone_t{}
...
func decodeE2nodeComponentConfigUpdateEngNb(e2nodeComponentConfigUpdateEngNbC *C.E2nodeComponentConfigUpdateENgNBVone_t) (*e2ap_ies.E2NodeComponentConfigUpdateEngNb, error) {
...
func decodeE2nodeComponentConfigUpdateEngNbBytes(array [8]byte) (*e2ap_ies.E2NodeComponentConfigUpdateEngNb, error) {
	e2nodeComponentConfigUpdateEngNbC := (*C.E2nodeComponentConfigUpdateENgNBVone_t)(unsafe.Pointer(uintptr(binary.LittleEndian.Uint64(array[0:8]))))
